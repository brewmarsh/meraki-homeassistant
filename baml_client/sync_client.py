...
class BamlSyncClient:
    ...
    def ExtractIntent(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> types.Intent:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            __stream__ = self.stream.ExtractIntent(input=input,
            ...
            return typing.cast(types.Intent, __result__.cast_to(types, types, stream_types, False, __runtime__))
    def RouteMerakiIntent(self, user_command: str,
        baml_options: BamlCallOptions = {},
    ) -> types.MerakiIntentResponse:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            __stream__ = self.stream.RouteMerakiIntent(user_command=user_command,
                baml_options=baml_options)
            return __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="RouteMerakiIntent", args={
                "user_command": user_command,
            })
            return typing.cast(types.MerakiIntentResponse, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ExtractIntent(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Intent, types.Intent]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractIntent", args={
            "input": input,
        })
        return baml_py.BamlSyncStream[stream_types.Intent, types.Intent](
          __result__,
    ...
    def RouteMerakiIntent(self, user_command: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.MerakiIntentResponse, types.MerakiIntentResponse]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="RouteMerakiIntent", args={
            "user_command": user_command,
        })
        return baml_py.BamlSyncStream[stream_types.MerakiIntentResponse, types.MerakiIntentResponse](
          __result__,
          lambda x: typing.cast(stream_types.MerakiIntentResponse, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.MerakiIntentResponse, x.cast_to(types, types, stream_types, False, __runtime__)),
          __ctx__,
        )
...
class BamlHttpRequestClient:
    ...
    def RouteMerakiIntent(self, user_command: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="RouteMerakiIntent", args={
            "user_command": user_command,
        }, mode="request")
        return __result__
