      ...
      return (
        ...
        j > B
          ? ((_.sortIndex = j),
            ...
            n(s) === null &&
              _ === n(c) &&
              (S ? (f(P), (P = -1)) : (S = !0), yl(v, j - B)))
          : ((_.sortIndex = G), t(s, _), k || w || ((k = !0), vl(x))),
        _
      );
    }),
...
function On(e) {
  ...
  for (; 0 < be.length && ((n = be[0]), n.blockedOn === null); )
    Rs(n), n.blockedOn === null && be.shift();
}
...
var Or = null;
function ci(e, t, n, r) {
  if (((Or = null), (e = Yi(r)), (e = kt(e)), e !== null))
...
var on = {
  ...
  nl = V({}, Zn, {
    ...
    movementX: function (e) {
      return 'movementX' in e
        ...
        : (e !== mn &&
            (mn && e.type === 'mousemove'
              ? ((Cl = e.screenX - mn.screenX), (Nl = e.screenY - mn.screenY))
              : (Nl = Cl = 0),
            (mn = e)),
          Cl);
    },
  ...
  Pl = we(uf),
  sf = V({}, on, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  af = we(sf),
  cf = V({}, on, {
...
var yf = V({}, Zn, {
  ...
  Sf = we(kf),
  xf = V({}, on, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ef = we(xf),
  _f = V({}, nl, {
    deltaX: function (e) {
      return 'deltaX' in e
...
var Pf = Qe && 'TextEvent' in window && !_n,
  Is = Qe && (!no || (_n && 8 < _n && 11 >= _n)),
  bo = ' ',
  eu = !1;
function Os(e, t) {
  switch (e) {
  ...
  ws(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              ...
              ((d = v),
              f !== null &&
                ((v = Dn(a, f)), v != null && S.push(An(a, v, d)))),
            L)
          )
            break;
          a = a.return;
        ...
        0 < S.length &&
          ((p = new w(p, k, null, n, h)), m.push({ event: p, listeners: S }));
      }
    }
    if (!(t & 7)) {
      e: {
      ...
      if (no)
        ...
        It
          ? Os(e, n) && (P = 'onCompositionEnd')
          : e === 'keydown' && n.keyCode === 229 && (P = 'onCompositionStart');
      P &&
        (Is &&
          n.locale !== 'ko' &&
          (It || P !== 'onCompositionStart'
            ? P === 'onCompositionEnd' && It && (N = Ms())
            : ((tt = h),
...
function au(e, t, n, r, l) {
  for (var i = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = Dn(n, i)), s != null && o.unshift(An(n, s, u)))
        : l || ((s = Dn(n, i)), s != null && o.push(An(n, s, u)))),
      (n = n.return);
  }
...
var un = Math.random().toString(36).slice(2),
  Fe = '__reactFiber$' + un,
  Vn = '__reactProps$' + un,
  Xe = '__reactContainer$' + un,
  yi = '__reactEvents$' + un,
  Yf = '__reactListeners$' + un,
  Gf = '__reactHandles$' + un;
function kt(e) {
  var t = e[Fe];
  if (t) return t;
...
function io(e) {
  for (; e === Vr; )
    (Vr = At[--Vt]), (At[Vt] = null), (Wr = At[--Vt]), (At[Vt] = null);
  for (; e === Nt; )
    (Nt = ke[--Se]),
      (ke[Se] = null),
      (He = ke[--Se]),
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Nt !== null ? { id: We, overflow: He } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function na(e) {
  ...
  function w(f, a, d, v, x) {
    ...
    if (typeof v == 'object' && v !== null) {
      switch (v.$$typeof) {
        case nr:
          return (
            (f = f.get(v.key === null ? d : v.key) || null), s(a, f, v, x)
          );
        case Dt:
          return (
            (f = f.get(v.key === null ? d : v.key) || null), c(a, f, v, x)
          );
        case Je:
          var C = v._init;
  ...
  function S(f, a, d, v) {
    ...
    if (R.done) return n(f, N), U && gt(f, P), x;
    if (N === null) {
...
function sa(e, t) {
  ...
  if (
    ...
    if (
      ((n.flags |= 2048),
      Xn(9, ca.bind(null, n, r, l, t), void 0, null),
      J === null)
    )
      throw Error(y(349));
    Pt & 30 || aa(n, t, l);
...
function td(e, t, n) {
  ...
  if (Ea(e)) _a(t, l);
    ...
    (n = la(e, t, l, r)),
      n !== null && ((l = oe()), De(n, e, r, l), Ca(n, t, r));
  }
}
function Ea(e) {
  var t = e.alternate;
  ...
  nd = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Xn(9, ca.bind(null, r, i, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function _u(e, t, n) {
  ...
  if (r === null) {
    ...
    (l = r.get(t)),
      l === void 0 && ((l = /* @__PURE__ */ new Set()), r.set(t, l));
...
function ju(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null))
    Nr(e, t), Na(t, n, r), Ei(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
    ...
    u !== m || p !== k || fe.current || qe
      ? (typeof w == 'function' && (xi(t, n, w, r), (k = t.memoizedState)),
        (c = qe || xu(t, n, c, r, p, k, s) || !1)
          ? (h ||
...
function ud(e, t, n, r, l, i, o) {
  ...
  if (l.data === '$!') {
    ...
    return (
      (r = u), (i = Error(y(419))), (r = Vl(i, r, void 0)), mr(e, t, o, r)
    );
  }
...
function dd(e, t) {
  ...
  for (
    mi = { focusedElem: e, selectionRange: n }, Ir = !1, E = t;
    E !== null;
...
function Wa(e, t, n) {
  for (var r = (e.mode & 1) !== 0; E !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (E = i)) : Iu(e);
  }
}
function Iu(e) {
  for (; E !== null; ) {
...
function De(e, t, n, r) {
  ...
  Gn(e, n, r),
    (!(D & 2) || e !== J) &&
      (e === J && (!(D & 2) && (cl |= n), Y === 4 && et(e, b)),
      pe(e, r),
      n === 1 && D === 0 && !(t.mode & 1) && ((rn = Q() + 500), ol && ht()));
}
function pe(e, t) {
...
function Ha(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = qr(e, r);
    ...
    so(),
      (Gr.current = i),
      (D = l),
      X !== null ? (t = 0) : ((J = null), (b = 0), (t = Y));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((l = si(e)), l !== 0 && ((r = l), (t = Oi(e, l)))), t === 1)
    )
      throw ((n = Kn), Et(e, 0), et(e, r), pe(e, Q()), n);
    if (t === 6) et(e, r);
    else {
      if (
...
function Et(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), Qf(n)), X !== null))
  ...
  if (nt !== null) {
    ...
    try {
      if (((Ee.transition = null), (M = 16 > e ? 16 : e), nt === null))
        ...
        if (
          ((D = l), ht(), Ue && typeof Ue.onPostCommitFiberRoot == 'function')
        )
          try {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Zi(t, n | 1), pe(t, Q()), !(D & 6) && ((rn = Q() + 500), ht()));
      }
      break;
    case 13:
      jt(function () {
...
ys = Co;
gs = jt;
var zd = { usingClientEntryPoint: !1, Events: [Jn, Ut, il, hs, vs, Co] },
  yn = {
...
const Ld = ({ devices: e, setActiveView: t }) => {
    const [n, r] = Te.useState(''),
      l = (u) =>
        u != null && u.startsWith('MR')
          ? 'mdi:access-point'
          : u != null && u.startsWith('MS')
            ? 'mdi:lan'
            : u != null && u.startsWith('MV')
              ? 'mdi:cctv'
              : 'mdi:help-circle',
      i = e.filter((u) => {
        var s, c;
    ...
    return /* @__PURE__ */ g.jsxs('div', {
      ...
      children: [
        ...
        /* @__PURE__ */ g.jsx('div', {
          ...
          children: /* @__PURE__ */ g.jsxs('table', {
            className: 'min-w-full',
            children: [
              /* @__PURE__ */ g.jsx('thead', {
                children: /* @__PURE__ */ g.jsxs('tr', {
                  className:
  ...
  Dd = ({ data: e, onToggle: t, setActiveView: n }) => {
    const [r, l] = Te.useState(null),
      i = (s) => {
        l(r === s ? null : s);
      },
      { networks: o, devices: u } = e;
    return !o || o.length === 0
      ? /* @__PURE__ */ g.jsx('p', { children: 'No networks found.' })
      : /* @__PURE__ */ g.jsx('div', {
          style: { display: 'flex', flexDirection: 'column', gap: '16px' },
          children: o.map((s) => {
            const c = r === s.id,
              h = s.ssids ? s.ssids.filter((p) => p.enabled).length : 0,
              m = s.ssids ? s.ssids.length : 0;
              ...
              'ha-card',
              {
                children: [
                  /* @__PURE__ */ g.jsxs('div', {
                    ...
                    children: [
                      /* @__PURE__ */ g.jsxs('span', {
                        children: ['[Network] ', s.name],
                      }),
                      /* @__PURE__ */ g.jsx('ha-icon', {
  ...
  Md = ({ activeView: e, setActiveView: t, data: n }) => {
    const r = n.devices.find((m) => m.serial === e.deviceId);
    if (!r)
      return /* @__PURE__ */ g.jsxs('div', {
        children: [
          /* @__PURE__ */ g.jsx('button', {
          ...
          /* @__PURE__ */ g.jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ g.jsx('div', {
                ...
                children: /* @__PURE__ */ g.jsx('ul', {
                  children: c.map((m, p) =>
                    /* @__PURE__ */ g.jsx(
                      'li',
                      { className: 'mb-1', children: m },
                      p
                    )
                  ),
                }),
  ...
  Id = ({ hass: e, config_entry_id: t }) => {
    const [n, r] = Te.useState(null),
      [l, i] = Te.useState(!0),
      [o, u] = Te.useState(null),
      [s, c] = Te.useState({
        view: 'dashboard',
        deviceId: void 0,
      }),
      h = Te.useRef(null),
      m = t || window.CONFIG_ENTRY_ID;
    if (
      (Te.useEffect(() => {
        ...
        if (e) {
          ...
          (async () => {
            try {
              ...
              console.error('Error fetching Meraki data:', a),
                u(
                  `Failed to fetch Meraki data: ${a.message || 'Unknown error'}`
                );
            } finally {
              i(!1);
            }
          ...
          (L.onmessage = (a) => {
            ...
            if (d.type === 'auth_ok')
              ...
              console.error('Authentication failed:', d.message),
                u('Authentication failed. Please check your token.'),
                i(!1),
                localStorage.removeItem('meraki_ha_llat');
            else if (d.id === f && d.type === 'result') {
              if (d.success) {
                const v = d.result,
                  { networks: x, enabled_networks: C } = v;
                if (x && C) {
                  const N = x.map((P) => ({
                    ...P,
                ...
                console.error('Failed to fetch Meraki data:', d.error),
                  u(`Failed to fetch Meraki data: ${d.error.message}`);
              i(!1);
            }
          }),
          (L.onerror = (a) => {
            console.error('WebSocket error:', a),
              u('WebSocket connection error. See console for details.'),
              i(!1);
          }),
          (L.onclose = () => {
    ...
    const p = async (w, k) => {
      if (!n) return;
      const S = n.networks.map((a) =>
          a.id === w ? { ...a, is_enabled: k } : a
        ),
        L = { ...n, networks: S };
      r(L);
...
class Od extends HTMLElement {
  connectedCallback() {
    ...
    const l = this.hass,
      i = this.panel,
      o =
        (s = i == null ? void 0 : i.config) == null
          ? void 0
          : s.config_entry_id;
    Ql.createRoot(r).render(
      /* @__PURE__ */ g.jsx(gc.StrictMode, {
        children: /* @__PURE__ */ g.jsx(Id, { hass: l, config_entry_id: o }),
      })
    );
  }
}
customElements.get('meraki-panel') ||
  customElements.define('meraki-panel', Od);
