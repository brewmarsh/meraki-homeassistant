...
var jp = (Wt, qe, it) =>
  qe in Wt
    ? Sp(Wt, qe, { enumerable: !0, configurable: !0, writable: !0, value: it })
    : (Wt[qe] = it);
var $t = (Wt, qe, it) => jp(Wt, typeof qe != 'symbol' ? qe + '' : qe, it);
(function () {
  'use strict';
  function Wt(e) {
    return e &&
   ...
   */ var In = Symbol.for('react.element'),
  ...
  var Vl = (Bl.prototype = new as());
  (Vl.constructor = Bl), os(Vl, on.prototype), (Vl.isPureReactComponent = !0);
  ...
  function Cr(e, t, n, r, l) {
    ...
    else if (((u = Uc(e)), typeof u == 'function'))
      for (e = u.call(e), a = 0; !(i = e.next()).done; )
        (i = i.value), (u = r + bl(i, a++)), (s += Cr(i, t, n, u, l));
    else if (i === 'object')
      throw (
        ((t = String(e)),
        Error(
  ...
  (F.Children = {
    ...
    (F.StrictMode = Lc),
    (F.Suspense = Ic),
    (F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Bc),
    (F.act = ms),
    (F.cloneElement = function (e, t, n) {
      ...
      if (t != null) {
        if (
          (t.ref !== void 0 && ((i = t.ref), (s = Hl.current)),
   ...
   */ var Vc = W,
    ...
    Kc =
      Vc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
  ...
  function hs(e, t, n) {
    ...
    for (r in t) bc.call(t, r) && !Yc.hasOwnProperty(r) && (l[r] = t[r]);
    if (e && e.defaultProps)
  ...
  (it.Fragment = Qc), (it.jsx = hs), (it.jsxs = hs), (qe.exports = it);
  var o = qe.exports,
    Kl = {},
    vs = { exports: {} },
    Le = {},
   ...
   */ (function (e) {
    ...
    function r(z) {
      ...
      if (I !== D) {
        z[0] = I;
        e: for (var U = 0, Z = z.length, At = Z >>> 1; U < At; ) {
          var oe = 2 * (U + 1) - 1,
            $ = z[oe],
            Ve = oe + 1,
            vt = z[Ve];
          if (0 > l($, I))
            Ve < Z && 0 > l(vt, $)
              ? ((z[U] = vt), (z[Ve] = I), (U = Ve))
              : ((z[U] = $), (z[oe] = I), (U = oe));
          else if (Ve < Z && 0 > l(vt, I)) (z[U] = vt), (z[Ve] = I), (U = Ve);
          else break e;
        }
      }
      return D;
    ...
    function l(z, D) {
      var I = z.sortIndex - D.sortIndex;
      return I !== 0 ? I : z.id - D.id;
    }
    if (
    ...
    function w(z) {
      if (((S = !1), p(z), !k))
        if (n(u) !== null) (k = !0), Je(E);
        else {
          var D = n(d);
          D !== null && Ut(w, D.startTime - z);
        }
    }
    function E(z, D) {
      (k = !1), S && ((S = !1), f(L), (L = -1)), (x = !0);
      var I = m;
      try {
        for (
          p(D), h = n(u);
          h !== null && (!(h.expirationTime > D) || (z && !ge()));

        ) {
          var U = h.callback;
          if (typeof U == 'function') {
            (h.callback = null), (m = h.priorityLevel);
            var Z = U(h.expirationTime <= D);
            (D = e.unstable_now()),
        ...
        if (h !== null) var At = !0;
          ...
          var oe = n(d);
          oe !== null && Ut(w, oe.startTime - D), (At = !1);
        }
        return At;
      } finally {
        (h = null), (m = I), (x = !1);
    ...
    (e.unstable_IdlePriority = 5),
      ...
      (e.unstable_scheduleCallback = function (z, D, I) {
        ...
        return (
          ...
          I > U
            ? ((z.sortIndex = I),
              ...
              n(u) === null &&
                z === n(d) &&
                (S ? (f(L), (L = -1)) : (S = !0), Ut(w, I - U)))
            : ((z.sortIndex = Z), t(u, z), k || x || ((k = !0), Je(E))),
          z
        );
      }),
  ...
  function sn(e, t) {
    for (Fn[e] = t, e = 0; e < t.length; e++) ys.add(t[e]);
  }
  var ot = !(
      typeof window > 'u' ||
  ...
  var st = Xc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
` + l[s].replace(' at new ', ' at ');
  ...
  function ui(e, t) {
    ...
    t.hasOwnProperty('value')
      ? ci(e, t.type, n)
      : t.hasOwnProperty('defaultValue') && ci(e, t.type, yt(t.defaultValue)),
      t.checked == null &&
  ...
  function Us(e) {
    if ((e = ur(e))) {
      if (typeof gi != 'function') throw Error(j(280));
      var t = e.stateNode;
      t && ((t = el(t)), gi(e.stateNode, e.type, t));
    }
  }
  function As(e) {
  ...
  function ad(e, t, n, r, l, i, s, a, u) {
    (Hn = !1), (Dr = null), od.apply(sd, arguments);
  }
  function ud(e, t, n, r, l, i, s, a, u) {
    if ((ad.apply(this, arguments), Hn)) {
      if (Hn) {
        var d = Dr;
        (Hn = !1), (Dr = null);
  ...
  function cd(e) {
    ...
    for (var n = e, r = t; ; ) {
      ...
      if (l.child === i.child) {
        for (i = l.child; i; ) {
          if (i === n) return Qs(l), e;
          if (i === r) return Qs(l), t;
          i = i.sibling;
        }
        throw Error(j(188));
      }
  ...
  function bs(e) {
    return (e = cd(e)), e !== null ? Ks(e) : null;
  }
  function Ks(e) {
  ...
  var Ys = Te.unstable_scheduleCallback,
    Gs = Te.unstable_cancelCallback,
    dd = Te.unstable_shouldYield,
    fd = Te.unstable_requestPaint,
    q = Te.unstable_now,
    pd = Te.unstable_getCurrentPriorityLevel,
    ki = Te.unstable_ImmediatePriority,
    Xs = Te.unstable_UserBlockingPriority,
    Rr = Te.unstable_NormalPriority,
    md = Te.unstable_LowPriority,
  ...
  var Qe = Math.clz32 ? Math.clz32 : xd,
    vd = Math.log,
    gd = Math.LN2;
  function xd(e) {
  ...
  function jd(e, t, n, r, l) {
    switch (t) {
      ...
      case 'dragenter':
        return (kt = Gn(kt, e, t, n, r, l)), !0;
      case 'mouseover':
        return (St = Gn(St, e, t, n, r, l)), !0;
      case 'pointerover':
        var i = l.pointerId;
        return Kn.set(i, Gn(Kn.get(i) || null, e, t, n, r, l)), !0;
      case 'gotpointercapture':
        return (
          (i = l.pointerId),
          Yn.set(i, Gn(Yn.get(i) || null, e, t, n, r, l)),
          !0
        );
    }
    return !1;
  ...
  function $r(e) {
    ...
    for (var t = e.targetContainers; 0 < t.length; ) {
      ...
      } else return (t = ur(n)), t !== null && Ci(t), (e.blockedOn = n), !1;
      t.shift();
    }
    return !0;
  }
  ...
  function Xn(e, t) {
    e.blockedOn === t &&
      ...
      _i ||
        ((_i = !0),
        Te.unstable_scheduleCallback(Te.unstable_NormalPriority, Nd)));
  }
  function Zn(e) {
    function t(l) {
      return Xn(l, e);
    ...
    for (; 0 < jt.length && ((n = jt[0]), n.blockedOn === null); )
      ia(n), n.blockedOn === null && jt.shift();
  }
  ...
  function Ei(e, t, n, r) {
    if (Wr) {
      var l = zi(e, t, n, r);
      if (l === null) Qi(e, t, r, Br, n), la(e, r);
      else if (jd(l, e, t, n, r)) r.stopPropagation();
      else if ((la(e, r), t & 4 && -1 < Sd.indexOf(e))) {
        for (; l !== null; ) {
          var i = ur(l);
          if (
            (i !== null && ea(i),
            (i = zi(e, t, n, r)),
            i === null && Qi(e, t, r, Br, n),
            i === l)
          )
            break;
          l = i;
  ...
  var Br = null;
  function zi(e, t, n, r) {
    if (((Br = null), (e = vi(r)), (e = Ht(e)), e !== null))
  ...
  var mn = {
    ...
    br = Y({}, Jn, {
      ...
      movementX: function (e) {
        return 'movementX' in e
          ...
          : (e !== qn &&
              (qn && e.type === 'mousemove'
                ? ((Ti = e.screenX - qn.screenX),
                  (Di = e.screenY - qn.screenY))
                : (Di = Ti = 0),
              (qn = e)),
            Ti);
      },
    ...
    ca = De(br),
    zd = Y({}, br, { dataTransfer: 0 }),
    Pd = De(zd),
    Ld = Y({}, Jn, { relatedTarget: 0 }),
    Mi = De(Ld),
    Td = Y({}, mn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Dd = De(Td),
    Md = Y({}, mn, {
  ...
  var $d = Y({}, Jn, {
    ...
    Hd = De(Vd),
    Qd = Y({}, mn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    bd = De(Qd),
    Kd = Y({}, br, {
      deltaX: function (e) {
        return 'deltaX' in e
    ...
    Yd = De(Kd),
    Gd = [9, 13, 27, 32],
    Ii = ot && 'CompositionEvent' in window,
    er = null;
  ot && 'documentMode' in document && (er = document.documentMode);
  var Xd = ot && 'TextEvent' in window && !er,
    pa = ot && (!Ii || (er && 8 < er && 11 >= er)),
    ma = ' ',
    ha = !1;
  function va(e, t) {
    switch (e) {
  ...
  function Jd(e, t) {
    if (hn)
      return e === 'compositionend' || (!Ii && va(e, t))
        ? ((e = aa()), (Vr = Pi = Nt = null), (hn = !1), e)
        : null;
    switch (e) {
      case 'paste':
        return null;
    ...
    if (ot) {
      ...
      if (!Oi) {
        ...
        ka.setAttribute('oninput', 'return;'),
          (Oi = typeof ka.oninput == 'function');
      }
      Fi = Oi;
    } else Fi = !1;
    wa = Fi && (!document.documentMode || 9 < document.documentMode);
  }
  function Sa() {
    tr && (tr.detachEvent('onpropertychange', ja), (nr = tr = null));
  }
  function ja(e) {
    if (e.propertyName === 'value' && Kr(nr)) {
      var t = [];
      ya(t, nr, e, vi(e)), Vs(ef, t);
    }
  }
  function nf(e, t, n) {
    e === 'focusin'
      ? (Sa(), (tr = t), (nr = n), tr.attachEvent('onpropertychange', ja))
      : e === 'focusout' && Sa();
  }
  function rf(e) {
  ...
  var be = typeof Object.is == 'function' ? Object.is : sf;
  function rr(e, t) {
    if (be(e, t)) return !0;
    if (
      typeof e != 'object' ||
    ...
    for (r = 0; r < n.length; r++) {
      var l = n[r];
      if (!Yl.call(t, l) || !be(e[l], t[l])) return !1;
    }
    return !0;
  }
  function Na(e) {
  ...
  var uf = ot && 'documentMode' in document && 11 >= document.documentMode,
    vn = null,
    Ai = null,
    lr = null,
    $i = !1;
  ...
  function Gr(e) {
    ...
    var t = gn[e],
      n;
    for (n in t) if (t.hasOwnProperty(n) && n in Pa) return (Wi[e] = t[n]);
    return e;
  }
  var La = Gr('animationend'),
    Ta = Gr('animationiteration'),
    Da = Gr('animationstart'),
    Ma = Gr('transitionend'),
    Ra = new Map(),
    Ia =
  ...
  for (var Bi = 0; Bi < Ia.length; Bi++) {
    var Vi = Ia[Bi],
      cf = Vi.toLowerCase(),
      df = Vi[0].toUpperCase() + Vi.slice(1);
    Ct(cf, 'on' + df);
  }
  Ct(La, 'onAnimationEnd'),
    Ct(Ta, 'onAnimationIteration'),
    Ct(Da, 'onAnimationStart'),
    Ct('dblclick', 'onDoubleClick'),
    Ct('focusin', 'onFocus'),
    Ct('focusout', 'onBlur'),
    Ct(Ma, 'onTransitionEnd'),
  ...
  function Oa(e, t) {
    ...
    if (Mr) throw ((e = wi), (Mr = !1), (wi = null), e);
  }
  function Q(e, t) {
    var n = t[Zi];
    ...
    if (!e[Xr]) {
      (e[Xr] = !0),
        ys.forEach(function (n) {
          n !== 'selectionchange' && (ff.has(n) || Hi(n, !1, e), Hi(n, !0, e));
        });
      var t = e.nodeType === 9 ? e : e.ownerDocument;
      t === null || t[Xr] || ((t[Xr] = !0), Hi('selectionchange', !1, t));
    }
  }
  function Ua(e, t, n, r) {
    switch (sa(t)) {
  ...
  function Qi(e, t, n, r, l) {
    ...
    Vs(function () {
          ...
          for (var c = d, p; c !== null; ) {
            ...
            if (
              (p.tag === 5 &&
                ...
                ((p = w),
                f !== null &&
                  ((w = Bn(c, f)), w != null && S.push(sr(c, w, p)))),
              R)
            )
              break;
            c = c.return;
      ...
      if (!(t & 7)) {
        e: {
          ...
          if (
            ...
            if (
              ...
              (R = x == null ? m : wn(x)),
              (p = k == null ? m : wn(k)),
              (m = new S(w, c + 'leave', x, n, v)),
              (m.target = R),
              (m.relatedTarget = p),
              (w = null),
              Ht(v) === d &&
                ((S = new S(f, c + 'enter', k, n, v)),
                (S.target = p),
                (S.relatedTarget = R),
                (w = S)),
              (R = w),
              ...
              t: {
                for (S = x, f = k, c = 0, p = S; p; p = xn(p)) c++;
        ...
        switch (((g = d ? wn(d) : window), e)) {
          case 'focusin':
            (xa(g) || g.contentEditable === 'true') &&
              ((vn = g), (Ai = d), (lr = null));
            break;
          case 'focusout':
            lr = Ai = vn = null;
        ...
        L &&
          (pa &&
            ...
            (hn || L !== 'onCompositionStart'
              ? L === 'onCompositionEnd' && hn && (_ = aa())
              : ((Nt = v),
                (Pi = 'value' in Nt ? Nt.value : Nt.textContent),
                (hn = !0))),
          (g = Zr(d, L)),
          0 < g.length &&
            ((L = new da(L, e, null, n, v)),
            h.push({ event: L, listeners: g }),
            _ ? (L.data = _) : ((_ = ga(n)), _ !== null && (L.data = _)))),
          (_ = Xd ? Zd(e, n) : Jd(e, n)) &&
            ((d = Zr(d, 'onBeforeInput')),
            0 < d.length &&
              ((v = new da('onBeforeInput', 'beforeinput', null, n, v)),
  ...
  function Aa(e, t, n, r, l) {
    for (var i = t._reactName, s = []; n !== null && n !== r; ) {
      ...
      a.tag === 5 &&
        ...
        ((a = d),
        l
          ? ((u = Bn(n, i)), u != null && s.unshift(sr(n, u, a)))
          : l || ((u = Bn(n, i)), u != null && s.push(sr(n, u, a)))),
        (n = n.return);
    }
...
`
  ...
  function Jr(e, t, n) {
    if (((t = $a(t)), $a(e) !== t && n)) throw Error(j(425));
  }
  function qr() {}
  var bi = null,
    Ki = null;
  ...
  var Gi = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    vf =
      typeof queueMicrotask == 'function'
        ...
        : typeof Wa < 'u'
        ? function (e) {
            return Wa.resolve(null).then(e).catch(gf);
          }
        : Gi;
  function gf(e) {
    setTimeout(function () {
  ...
  function Va(e, t, n) {
    if (pe.current !== zt) throw Error(j(168));
    H(pe, t), H(je, n);
  }
  function Ha(e, t, n) {
    var r = e.stateNode;
    if (((t = t.childContextTypes), typeof r.getChildContext != 'function'))
      return n;
    r = r.getChildContext();
    for (var l in r) if (!(l in t)) throw Error(j(108, nd(e) || 'Unknown', l));
    return Y({}, n, r);
  }
  function nl(e) {
    return (
  ...
  function Pt() {
    if (!qi && ut !== null) {
      ...
      try {
        ...
        throw (ut !== null && (ut = ut.slice(e + 1)), Ys(ki, Pt), l);
      } finally {
        (B = t), (qi = !1);
      }
    }
  ...
  var jn = [],
    ...
    dt = '';
  function Kt(e, t) {
    (jn[Nn++] = il), (jn[Nn++] = ll), (ll = e), (il = t);
  }
  function Ka(e, t, n) {
    (Oe[Ue++] = ct), (Oe[Ue++] = dt), (Oe[Ue++] = bt), (bt = e);
    var r = ct;
    e = dt;
    var l = 32 - Qe(r) - 1;
    (r &= ~(1 << l)), (n += 1);
  ...
  function eo(e) {
    e.return !== null && (Kt(e, 1), Ka(e, 1, 0));
  }
  function to(e) {
    for (; e === ll; )
      (ll = jn[--Nn]), (jn[Nn] = null), (il = jn[--Nn]), (jn[Nn] = null);
    for (; e === bt; )
      (bt = Oe[--Ue]),
        (Oe[Ue] = null),
        (dt = Oe[--Ue]),
    ...
    switch (e.tag) {
      ...
      case 13:
        return (
          ...
          t !== null
            ? ((n = bt !== null ? { id: ct, overflow: dt } : null),
              (e.memoizedState = {
                dehydrated: t,
                treeContext: n,
  ...
  function qa(e) {
        ...
        : c !== null &&
          (c.elementType === E ||
            (typeof E == 'object' &&
              ...
              E.$$typeof === xt &&
              Ja(E) === c.type))
        ? ((w = l(c, p.props)), (w.ref = cr(f, c, p)), (w.return = f), w)
        : ((w = Tl(p.type, p.key, p.props, null, f.mode, w)),
          (w.ref = cr(f, c, p)),
          (w.return = f),
          w);
    }
    function d(f, c, p, w) {
      return c === null ||
        ...
        ? ((c = Zo(p, f.mode, w)), (c.return = f), c)
        : ((c = l(c, p.children || [])), (c.return = f), c);
    }
    function v(f, c, p, w, E) {
      return c === null || c.tag !== 7
        ? ((c = tn(p, f.mode, w, E)), (c.return = f), c)
        : ((c = l(c, p)), (c.return = f), c);
    }
    function h(f, c, p) {
      ...
      if (typeof c == 'object' && c !== null) {
        switch (c.$$typeof) {
          case zr:
            return (
              (p = Tl(c.type, c.key, c.props, null, f.mode, p)),
              (p.ref = cr(f, null, c)),
              (p.return = f),
              p
            );
        ...
        if (An(c) || On(c))
          return (c = tn(c, f.mode, p, null)), (c.return = f), c;
        sl(f, c);
      }
      return null;
    }
    function m(f, c, p, w) {
      ...
      if ((typeof p == 'string' && p !== '') || typeof p == 'number')
        return E !== null ? null : a(f, c, '' + p, w);
      if (typeof p == 'object' && p !== null) {
        switch (p.$$typeof) {
          case zr:
            return p.key === E ? u(f, c, p, w) : null;
          case an:
            return p.key === E ? d(f, c, p, w) : null;
          case xt:
            return (E = p._init), m(f, c, E(p._payload), w);
        }
        if (An(p) || On(p)) return E !== null ? null : v(f, c, p, w, null);
        sl(f, p);
      }
      return null;
    }
    function x(f, c, p, w, E) {
      if ((typeof w == 'string' && w !== '') || typeof w == 'number')
        return (f = f.get(p) || null), a(c, f, '' + w, E);
      if (typeof w == 'object' && w !== null) {
        switch (w.$$typeof) {
          case zr:
            return (
              (f = f.get(w.key === null ? p : w.key) || null), u(c, f, w, E)
            );
          case an:
            return (
              (f = f.get(w.key === null ? p : w.key) || null), d(c, f, w, E)
            );
          case xt:
            var g = w._init;
            return x(f, c, p, g(w._payload), E);
        }
        if (An(w) || On(w)) return (f = f.get(p) || null), v(c, f, w, E, null);
        sl(c, w);
      }
      return null;
    }
    function k(f, c, p, w) {
      for (
        var E = null, g = null, _ = c, L = (c = 0), V = null;
        _ !== null && L < p.length;
        L++
      ) {
        _.index > L ? ((V = _), (_ = null)) : (V = _.sibling);
        var M = m(f, _, p[L], w);
        if (M === null) {
          _ === null && (_ = V);
          break;
        ...
        e && _ && M.alternate === null && t(f, _),
          (c = i(M, c, L)),
          g === null ? (E = M) : (g.sibling = M),
          (g = M),
          (_ = V);
      }
      if (L === p.length) return n(f, _), K && Kt(f, L), E;
      if (_ === null) {
        for (; L < p.length; L++)
          (_ = h(f, p[L], w)),
            _ !== null &&
              ((c = i(_, c, L)),
              g === null ? (E = _) : (g.sibling = _),
              (g = _));
        return K && Kt(f, L), E;
      }
      for (_ = r(f, _); L < p.length; L++)
        (V = x(_, f, L, p[L], w)),
          V !== null &&
            (e && V.alternate !== null && _.delete(V.key === null ? L : V.key),
            (c = i(V, c, L)),
            g === null ? (E = V) : (g.sibling = V),
            (g = V));
      return (
        e &&
    ...
    function S(f, c, p, w) {
      ...
      for (
        var g = (E = null), _ = c, L = (c = 0), V = null, M = p.next();
        _ !== null && !M.done;
        L++, M = p.next()
      ) {
        _.index > L ? ((V = _), (_ = null)) : (V = _.sibling);
        var ge = m(f, _, M.value, w);
        if (ge === null) {
          _ === null && (_ = V);
          break;
        }
        e && _ && ge.alternate === null && t(f, _),
          (c = i(ge, c, L)),
          g === null ? (E = ge) : (g.sibling = ge),
          (g = ge),
          (_ = V);
      }
      if (M.done) return n(f, _), K && Kt(f, L), E;
      if (_ === null) {
      ...
      for (_ = r(f, _); !M.done; L++, M = p.next())
        (M = x(_, f, L, M.value, w)),
          M !== null &&
            (e && M.alternate !== null && _.delete(M.key === null ? L : M.key),
            (c = i(M, c, L)),
            g === null ? (E = M) : (g.sibling = M),
            (g = M));
      return (
    ...
    function R(f, c, p, w) {
      if (
        ...
        switch (p.$$typeof) {
          case zr:
            e: {
              for (var E = p.key, g = c; g !== null; ) {
                if (g.key === E) {
                  if (((E = p.type), E === un)) {
                    if (g.tag === 7) {
                      n(f, g.sibling),
                        (c = l(g, p.props.children)),
                        (c.return = f),
                        (f = c);
                      break e;
                    }
              ...
              p.type === un
                ? ((c = tn(p.props.children, f.mode, w, p.key)),
                  (c.return = f),
                  (f = c))
                : ((w = Tl(p.type, p.key, p.props, null, f.mode, w)),
                  (w.ref = cr(f, c, p)),
          ...
          case an:
            e: {
              ...
              (c = Zo(p, f.mode, w)), (c.return = f), (f = c);
            }
            return s(f);
          case xt:
            return (g = p._init), R(f, c, g(p._payload), w);
        }
        if (An(p)) return k(f, c, p, w);
        if (On(p)) return S(f, c, p, w);
        sl(f, p);
      }
      return (typeof p == 'string' && p !== '') || typeof p == 'number'
        ? ((p = '' + p),
          c !== null && c.tag === 6
            ...
            : (n(f, c), (c = Xo(p, f.mode, w)), (c.return = f), (f = c)),
          s(f))
        : n(f, c);
    }
    return R;
  ...
  function fo(e, t) {
    switch ((H(pr, t), H(fr, e), H(nt, dr), (e = t.nodeType), e)) {
      case 9:
      case 11:
  ...
  var pl = st.ReactCurrentDispatcher,
    vo = st.ReactCurrentBatchConfig,
    Xt = 0,
    X = null,
    te = null,
    le = null,
  ...
  function xo(e, t, n, r, l, i) {
    if (
      ...
      (t.updateQueue = null),
      (t.lanes = 0),
      (pl.current = e === null || e.memoizedState === null ? _f : Ef),
      (e = n(r, l)),
      mr)
    ) {
      i = 0;
      do {
        if (((mr = !1), (hr = 0), 25 <= i)) throw Error(j(301));
        (i += 1),
          (le = te = null),
          (t.updateQueue = null),
          (pl.current = zf),
  ...
  function wo(e) {
    ...
    if (((e = n.interleaved), e !== null)) {
      l = e;
      do (i = l.lane), (X.lanes |= i), (Zt |= i), (l = l.next);
      while (l !== e);
  ...
  function su(e, t) {
    ...
    if (
      ...
      (r = r.queue),
      So(cu.bind(null, n, r, e), [e]),
      r.getSnapshot !== t || i || (le !== null && le.memoizedState.tag & 1))
    ) {
      if (
        ((n.flags |= 2048),
        gr(9, uu.bind(null, n, r, l, t), void 0, null),
        ie === null)
      )
        throw Error(j(349));
      Xt & 30 || au(n, t, l);
  ...
  function vl(e, t, n, r) {
    ...
    if (te !== null) {
      ...
      if (((i = s.destroy), r !== null && go(r, s.deps))) {
        l.memoizedState = gr(t, n, i, r);
        return;
      }
    }
    (X.flags |= e), (l.memoizedState = gr(1 | t, n, i, r));
  }
  function hu(e, t) {
  ...
  function yu(e, t, n) {
    return (
      (n = n != null ? n.concat([e]) : null), vl(4, 4, xu.bind(null, t, e), n)
    );
  }
  function jo() {}
  function wu(e, t) {
  ...
  function Su(e, t, n) {
    return Xt & 21
      ? (be(n, t) ||
          ((n = Js()), (X.lanes |= n), (Zt |= n), (e.baseState = !0)),
        t)
  ...
  function Cf(e, t, n) {
    ...
    if (Nu(e)) Cu(t, l);
      ...
      (n = tu(e, t, l, r)),
        n !== null && ((l = ke()), Ze(n, e, r, l), _u(n, t, r));
    }
  }
  function Nu(e) {
    var t = e.alternate;
  ...
  var gl = {
    ...
    _f = {
      ...
      useImperativeHandle: function (e, t, n) {
        return (
          ...
          hl(4194308, 4, xu.bind(null, t, e), n)
        );
      },
      ...
      useTransition: function () {
        var e = pu(!1),
          t = e[0];
        return (e = jf.bind(null, e[1])), (rt().memoizedState = e), [t, e];
      },
      ...
      useSyncExternalStore: function (e, t, n) {
        ...
        return (
          (l.queue = i),
          hu(cu.bind(null, r, i, e), [e]),
          (r.flags |= 2048),
          gr(9, uu.bind(null, r, i, n, t), void 0, null),
          n
        );
      },
      useId: function () {
    ...
    Ef = {
      ...
      useDeferredValue: function (e) {
        var t = $e();
        return Su(t, te.memoizedState, e);
      },
      useTransition: function () {
        var e = wo(vr)[0],
          t = $e().memoizedState;
  ...
  var xl = {
    ...
    enqueueForceUpdate: function (e, t) {
      ...
      (l.tag = 2),
        t != null && (l.callback = t),
        (t = Tt(e, l, r)),
        t !== null && (Ze(t, e, r, n), cl(t, e, r));
    },
  };
  function Eu(e, t, n, r, l, i, s) {
    return (
      (e = e.stateNode),
  ...
  function zu(e, t, n) {
    ...
    return (
      typeof i == 'object' && i !== null
        ? (i = Ae(i))
        : ((l = Ne(t) ? Qt : pe.current),
          (r = t.contextTypes),
          (i = (r = r != null) ? Sn(e, l) : zt)),
      (t = new t(n, i)),
      (e.memoizedState =
  ...
  function Co(e, t, n, r) {
    ...
    typeof i == 'object' && i !== null
      ? (l.context = Ae(i))
      : ((i = Ne(t) ? Qt : pe.current), (l.context = Sn(e, i))),
...
` +
  ...
  var Lf = st.ReactCurrentOwner,
    Ce = !1;
  function we(e, t, n, r) {
    t.child = e === null ? eu(t, null, n, r) : _n(t, e.child, n, r);
  }
    ...
    return (
      ...
      e !== null && !Ce
        ? ((t.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~l),
          mt(e, t, l))
        : (K && n && eo(t), (t.flags |= 1), we(e, t, r, l), t.child)
    );
  }
    ...
    return (
      ...
      e !== null && !Ce
        ? ((t.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~l),
          mt(e, t, l))
        : (K && r && eo(t), (t.flags |= 1), we(e, t, n, l), t.child)
    );
  }
  function $u(e, t, n, r, l) {
    ...
    if ((zn(t, l), t.stateNode === null))
      wl(e, t), zu(t, n, r), Co(t, n, r, l), (r = !0);
    else if (e === null) {
      var s = t.stateNode,
        a = t.memoizedProps;
      s.props = a;
      ...
      (s.state = m),
        dl(t, r, s, l),
        (u = t.memoizedState),
        a !== r || m !== u || je.current || Lt
          ? (typeof v == 'function' && (No(t, n, v, r), (u = t.memoizedState)),
            (a = Lt || Eu(t, n, a, r, m, u, d))
              ? (h ||
      ...
      (s = t.stateNode),
        nu(e, t),
        (a = t.memoizedProps),
        (d = t.type === t.elementType ? a : Ye(t.type, a)),
        (s.props = d),
        (h = t.pendingProps),
        (m = s.context),
        (u = n.contextType),
      ...
      a !== h || m !== k || je.current || Lt
        ? (typeof x == 'function' && (No(t, n, x, r), (k = t.memoizedState)),
          (d = Lt || Eu(t, n, d, r, m, k, u) || !1)
            ? (v ||
                (typeof s.UNSAFE_componentWillUpdate != 'function' &&
                  typeof s.componentWillUpdate != 'function') ||
                (typeof s.componentWillUpdate == 'function' &&
                  s.componentWillUpdate(r, k, u),
                typeof s.UNSAFE_componentWillUpdate == 'function' &&
                  s.UNSAFE_componentWillUpdate(r, k, u)),
  ...
  function Po(e, t, n, r, l, i) {
    Au(e, t);
    var s = (t.flags & 128) !== 0;
    if (!r && !s) return l && Qa(t, n, !1), mt(e, t, i);
    ...
    return (
      (t.flags |= 1),
      e !== null && s
        ? ((t.child = _n(t, e.child, null, i)), (t.child = _n(t, null, a, i)))
        : we(e, t, a, i),
  ...
  function Bu(e, t, n, r, l) {
    return Cn(), lo(l), (t.flags |= 256), we(e, t, n, r), t.child;
  }
  ...
  function Vu(e, t, n) {
    ...
    if (
      ((l = e.memoizedState), l !== null && ((a = l.dehydrated), a !== null))
    )
      return Tf(e, t, s, r, a, l, n);
    if (i) {
  ...
  function Tf(e, t, n, r, l, i, s) {
    if (n)
      return t.flags & 256
        ? ((t.flags &= -257), (r = _o(Error(j(422)))), yl(e, t, s, r))
        : t.memoizedState !== null
        ...
        : ((i = r.fallback),
          ...
          (t.child.memoizedState = To(s)),
          (t.memoizedState = Lo),
          i);
    if (!(t.mode & 1)) return yl(e, t, s, null);
    if (l.data === '$!') {
      if (((r = l.nextSibling && l.nextSibling.dataset), r)) var a = r.dgst;
      return (
        (r = a), (i = Error(j(419))), (r = _o(i, r, void 0)), yl(e, t, s, r)
      );
    }
    if (((a = (s & e.childLanes) !== 0), Ce || a)) {
      if (((r = ie), r !== null)) {
        ...
        (l = l & (r.suspendedLanes | s) ? 0 : l),
          l !== 0 &&
            l !== i.retryLane &&
            ((i.retryLane = l), ft(e, l), Ze(r, e, l, -1));
      }
      return Yo(), (r = _o(Error(j(421)))), yl(e, t, s, r);
    }
    return l.data === '$?'
      ? ((t.flags |= 128),
        (t.child = e.child),
  ...
  function Qu(e, t, n) {
    var r = t.pendingProps,
      l = r.revealOrder,
      i = r.tail;
    if ((we(e, t, r.children, n), (r = G.current), r & 2))
      (r = (r & 1) | 2), (t.flags |= 128);
    else {
  ...
  function Df(e, t, n) {
    switch (t.tag) {
      ...
      case 10:
        ...
        H(al, r._currentValue), (r._currentValue = l);
        break;
      case 13:
    ...
    switch ((to(t), t.tag)) {
      ...
      case 5:
        ...
        if (((n = t.type), e !== null && t.stateNode != null))
          ...
          if (((e = Gt(nt.current)), ol(t))) {
            (r = t.stateNode), (n = t.type);
            var i = t.memoizedProps;
            switch (((r[tt] = t), (r[ar] = i), (e = (t.mode & 1) !== 0), n)) {
              case 'dialog':
              ...
              case 'video':
              case 'audio':
                for (l = 0; l < ir.length; l++) Q(ir[l], r);
                break;
              case 'source':
                Q('error', r);
                break;
            ...
            e: {
              switch (((s = mi(n, r)), n)) {
                ...
                case 'video':
                case 'audio':
                  for (l = 0; l < ir.length; l++) Q(ir[l], e);
                  l = r;
                  break;
                case 'source':
                  Q('error', e), (l = r);
              ...
              for (i in a)
                if (a.hasOwnProperty(i)) {
                  ...
                  i === 'style'
                    ...
                    ? ((u = u ? u.__html : void 0), u != null && Is(e, u))
                    : i === 'children'
                    ? typeof u == 'string'
                      ? (n !== 'textarea' || u !== '') && $n(e, u)
      ...
      case 6:
        if (e && t.stateNode != null) Yu(e, t, e.memoizedProps, r);
          ...
          if (typeof r != 'string' && t.stateNode === null)
            throw Error(j(166));
          if (((n = Gt(pr.current)), Gt(nt.current), ol(t))) {
            if (
              ((r = t.stateNode),
              (n = t.memoizedProps),
              (r[tt] = t),
          ...
          if (K && Re !== null && t.mode & 1 && !(t.flags & 128))
            ...
            if (e === null) {
              ...
              Cn(),
                ...
                (t.flags |= 4);
            he(t), (i = !1);
          } else Ke !== null && (Qo(Ke), (Ke = null)), (i = !0);
        ...
        return t.flags & 128
          ...
          : ((r = r !== null),
            r !== (e !== null && e.memoizedState !== null) &&
              ...
              ((t.child.flags |= 8192),
              t.mode & 1 &&
                (e === null || G.current & 1 ? ne === 0 && (ne = 3) : Yo())),
      ...
      case 10:
        return so(t.type._context), he(t), null;
      case 17:
        return Ne(t.type) && tl(), he(t), null;
      case 19:
        if ((b(G), (i = t.memoizedState), i === null)) return he(t), null;
  ...
  function Rf(e, t) {
    switch ((to(t), t.tag)) {
      ...
      case 13:
        if (
          (b(G), (e = t.memoizedState), e !== null && e.dehydrated !== null)
        ) {
  ...
  function Ff(e, t) {
    ...
    for (
      Ki = { focusedElem: e, selectionRange: n }, Wr = !1, P = t;
      P !== null;

    )
      if (
        ((t = P), (e = t.child), (t.subtreeFlags & 1028) !== 0 && e !== null)
      )
        (e.return = t), (P = e);
      else
        for (; P !== null; ) {
                  ...
                  if (k !== null) {
                    var S = k.memoizedProps,
                      ...
                      c = f.getSnapshotBeforeUpdate(
                        t.elementType === t.type ? S : Ye(t.type, S),
                        R
                      );
  ...
  function tc(e, t) {
    ...
    switch (e.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        Xe(t, e), lt(e), r & 512 && n !== null && Tn(n, n.return);
        break;
      case 5:
        if (
          (Xe(t, e),
            ...
            for (P = l; P !== null; )
              (s = P),
                ...
                s.tag === 22 && s.memoizedState !== null
                  ...
                  ? ((u.return = s), (P = u))
                  : ic(l);
          for (; i !== null; ) (P = i), nc(i), (i = i.sibling);
          (P = l), (kl = a), (ve = d);
        }
        rc(e);
      } else
  ...
  var Uf = Math.ceil,
    jl = st.ReactCurrentDispatcher,
    Ao = st.ReactCurrentOwner,
  ...
  function Ze(e, t, n, r) {
    if (50 < Sr) throw ((Sr = 0), (Vo = null), Error(j(185)));
    bn(e, n, r),
      (!(A & 2) || e !== ie) &&
        (e === ie && (!(A & 2) && (Nl |= n), ne === 4 && Ft(e, ue)),
        Ee(e, r),
        n === 1 && A === 0 && !(t.mode & 1) && ((Mn = q() + 500), rl && Pt()));
  }
  function Ee(e, t) {
    var n = e.callbackNode;
    wd(e, t);
    var r = Ur(e, e === ie ? ue : 0);
    if (r === 0)
      n !== null && Gs(n), (e.callbackNode = null), (e.callbackPriority = 0);
    else if (((t = r & -r), e.callbackPriority !== t)) {
      if ((n != null && Gs(n), t === 1))
        e.tag === 0 ? wf(sc.bind(null, e)) : ba(sc.bind(null, e)),
          vf(function () {
            !(A & 6) && Pt();
          }),
          (n = null);
  ...
  function oc(e, t) {
    if (((zl = -1), (Pl = 0), A & 6)) throw Error(j(327));
    var n = e.callbackNode;
    ...
    if (r & 30 || r & e.expiredLanes || t) t = Ll(e, r);
      ...
      A |= 2;
      var i = uc();
      (ie !== e || ue !== t) && ((ht = null), (Mn = q() + 500), qt(e, t));
      do
        try {
          Wf();
          break;
    ...
    if (t !== 0) {
      if (
        (t === 2 && ((l = Si(e)), l !== 0 && ((r = l), (t = Ho(e, l)))),
        t === 1)
      )
        throw ((n = wr), qt(e, 0), Ft(e, r), Ee(e, q()), n);
      if (t === 6) Ft(e, r);
      else {
        if (
        ...
        switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
          ...
          case 3:
            if (
              ...
              e.timeoutHandle = Gi(en.bind(null, e, _e, ht), t);
              break;
            }
            en(e, _e, ht);
            break;
          case 4:
            ...
            if (
              ...
              e.timeoutHandle = Gi(en.bind(null, e, _e, ht), r);
              break;
            }
            en(e, _e, ht);
            break;
    ...
    return Ee(e, q()), e.callbackNode === n ? oc.bind(null, e) : null;
  }
  function Ho(e, t) {
    var n = kr;
    return (
  ...
  function sc(e) {
    ...
    if (n === 1) throw ((n = wr), qt(e, 0), Ft(e, t), Ee(e, q()), n);
  ...
  function bo(e, t) {
    ...
    try {
      ...
      (A = n), A === 0 && ((Mn = q() + 500), rl && Pt());
    }
  }
  function Jt(e) {
    Rt !== null && Rt.tag === 0 && !(A & 6) && Rn();
    var t = A;
    A |= 1;
    var n = We.transition,
      r = B;
    try {
      ...
      (B = r), (We.transition = n), (A = t), !(A & 6) && Pt();
    }
  }
  function Ko() {
    (Ie = Dn.current), b(Dn);
  ...
  function qt(e, t) {
    ...
    if ((n !== -1 && ((e.timeoutHandle = -1), hf(n)), ee !== null))
  ...
  function Yo() {
    (ne === 0 || ne === 3 || ne === 2) && (ne = 4),
      ie === null || (!(Zt & 268435455) && !(Nl & 268435455)) || Ft(ie, ue);
  }
  function Ll(e, t) {
    var n = A;
    A |= 2;
    var r = uc();
    (ie !== e || ue !== t) && ((ht = null), qt(e, t));
    do
      try {
        $f();
        break;
    ...
    while (!0);
    if ((oo(), (A = n), (jl.current = r), ee !== null)) throw Error(j(261));
  ...
  function Wf() {
    for (; ee !== null && !dd(); ) cc(ee);
  }
  function cc(e) {
    var t = mc(e.alternate, e, Ie);
  ...
  function en(e, t, n) {
    var r = B,
      l = We.transition;
    try {
      (We.transition = null), (B = 1), Bf(e, t, n, r);
    } finally {
      (We.transition = l), (B = r);
    }
    return null;
  ...
  function Rn() {
    if (Rt !== null) {
      var e = qs(El),
        ...
        n = B;
      try {
        if (((We.transition = null), (B = 16 > e ? 16 : e), Rt === null))
          var r = !1;
        else {
          if (((e = Rt), (Rt = null), (El = 0), A & 6)) throw Error(j(331));
          var l = A;
  ...
  function Vf(e, t, n) {
    ...
    r !== null && r.delete(t),
      ...
      ie === e &&
        (ue & n) === n &&
        (ne === 4 || (ne === 3 && (ue & 130023424) === ue && 500 > q() - Wo)
          ? qt(e, 0)
          : ($o |= n)),
      Ee(e, t);
  }
  function pc(e, t) {
    t === 0 &&
      (e.mode & 1
        ...
        : (t = 1));
    var n = ke();
    (e = ft(e, t)), e !== null && (bn(e, t, n), Ee(e, n));
  }
  function Hf(e) {
    var t = e.memoizedState,
      n = 0;
  ...
  mc = function (e, t, n) {
    ...
    else (Ce = !1), K && t.flags & 1048576 && Ka(t, il, t.index);
    switch (((t.lanes = 0), t.tag)) {
      case 2:
        var r = t.type;
        wl(e, t), (e = t.pendingProps);
        var l = Sn(t, pe.current);
        zn(t, n), (l = xo(null, t, r, e, l, n));
        var i = yo();
        return (
          (t.flags |= 1),
          typeof l == 'object' &&
          ...
          l.$$typeof === void 0
            ? ((t.tag = 1),
              ...
              Co(t, r, e, n),
              (t = Po(null, t, r, !0, i, n)))
            : ((t.tag = 0), K && i && eo(t), we(null, t, l, n), (t = t.child)),
          t
        );
      case 16:
        r = t.elementType;
      ...
      case 3:
        e: {
          if ((Wu(t), e === null)) throw Error(j(387));
          (r = t.pendingProps),
            (i = t.memoizedState),
            (l = i.element),
            nu(e, t),
          ...
          if (((r = s.element), i.isDehydrated))
            if (
              ...
              (l = Ln(Error(j(423)), t)), (t = Bu(e, t, r, n, l));
              break e;
            } else if (r !== l) {
              (l = Ln(Error(j(424)), t)), (t = Bu(e, t, r, n, l));
              break e;
            } else
              for (
      ...
      case 5:
        return (
          ...
          (s = l.children),
          Yi(r, l) ? (s = null) : i !== null && Yi(r, i) && (t.flags |= 32),
          Au(e, t),
          we(e, t, s, n),
          t.child
        );
      ...
      case 4:
        return (
          fo(t, t.stateNode.containerInfo),
          (r = t.pendingProps),
          e === null ? (t.child = _n(t, null, r, n)) : we(e, t, r, n),
          t.child
        );
      case 11:
        return (
  ...
  function Tl(e, t, n, r, l, i) {
    var s = 2;
    if (((r = e), typeof e == 'function')) Go(e) && (s = 1);
      ...
      e: switch (e) {
        ...
        case ql:
          return (
            (e = Be(12, n, t, l | 2)), (e.elementType = ql), (e.lanes = i), e
          );
        case ti:
          return (e = Be(13, n, t, l)), (e.elementType = ti), (e.lanes = i), e;
        case ni:
          return (e = Be(19, n, t, l)), (e.elementType = ni), (e.lanes = i), e;
        case Ns:
          return Dl(n, l, i, t);
        default:
    ...
    return (
      (t = Be(s, n, t, l)), (t.elementType = e), (t.type = r), (t.lanes = i), t
    );
  }
  function tn(e, t, n, r) {
  ...
  function vc(e) {
    ...
    if (e.tag === 1) {
      var n = e.type;
      if (Ne(n)) return Ha(e, n, t);
    }
    return t;
  }
  function gc(e, t, n, r, l, i, s, a, u) {
    return (
      (e = Jo(n, r, !0, e, l, i, s, a, u)),
      (e.context = vc(null)),
      (n = e.current),
      (r = ke()),
      (l = It(n)),
  ...
  (Il.prototype.render = es.prototype.render =
    function (e) {
      var t = this._internalRoot;
      if (t === null) throw Error(j(409));
      Ml(e, t, null, null);
    }),
    (Il.prototype.unmount = es.prototype.unmount =
      function () {
  ...
  function Zf(e, t, n, r, l) {
    ...
    var u = Jo(e, 0, !1, null, null, !1, !1, '', wc);
    return (
  ...
  (ea = function (e) {
    switch (e.tag) {
      case 3:
        ...
        if (t.current.memoizedState.isDehydrated) {
          ...
          n !== 0 &&
            (Ni(t, n | 1), Ee(t, q()), !(A & 6) && ((Mn = q() + 500), Pt()));
        }
        break;
      case 13:
        Jt(function () {
    ...
    (Ws = bo),
    (Bs = Jt);
  var Jf = { usingClientEntryPoint: !1, Events: [ur, wn, el, As, $s, bo] },
    jr = {
    ...
    qf = {
      ...
      findFiberByHostInstance: jr.findFiberByHostInstance || Xf,
  ...
  (Le.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Jf),
    ...
    (Le.hydrateRoot = function (e, t, n) {
      ...
      if (
        ...
        (t = gc(t, null, e, 1, n ?? null, l, !1, i, s)),
        (e[at] = t.current),
        or(e),
        r)
      )
  ...
  var ep = vs.exports,
    Sc = ep;
  (Kl.createRoot = Sc.createRoot), (Kl.hydrateRoot = Sc.hydrateRoot);
  const Al = ({
      title: e,
      value: t,
      icon: n,
      ...
      const s = r === 'default' ? '' : r,
        a = l || i;
      return o.jsxs('div', {
        className: `stat-card ${a ? 'clickable' : ''}`,
        onClick: l,
        style: {
        ...
        onMouseEnter: (u) => {
          a &&
            ((u.currentTarget.style.transform = 'translateY(-2px)'),
            (u.currentTarget.style.boxShadow = '0 4px 12px rgba(0,0,0,0.15)'));
        },
        onMouseLeave: (u) => {
          a &&
            ((u.currentTarget.style.transform = 'translateY(0)'),
            (u.currentTarget.style.boxShadow = ''));
        },
        children: [
          o.jsx('div', { className: 'label', children: e }),
          o.jsxs('div', {
            className: `value ${s}`,
            children: [
              n &&
                o.jsx('span', { style: { marginRight: '8px' }, children: n }),
              t,
            ],
          }),
        ],
    ...
    np = ({
      ...
      data: t,
      hass: n,
      defaultViewMode: r = 'network',
      defaultDeviceTypeFilter: l = 'all',
      defaultStatusFilter: i = 'all',
      temperatureUnit: s = 'celsius',
    }) => {
      const [a, u] = W.useState(new Set()),
        [d, v] = W.useState(
          new Set(['switch', 'camera', 'wireless', 'sensor', 'appliance'])
        ),
        [h, m] = W.useState(l || 'all'),
        [x, k] = W.useState(i || 'all'),
        [S, R] = W.useState(r || 'network'),
        f = W.useRef(!1);
      if (
        (W.useEffect(() => {
          if (!f.current && t != null && t.networks) {
            const N = t.networks.map((T) => T.id);
            N.length > 0 && N.length <= 3 && (u(new Set(N)), (f.current = !0));
          }
        ...
        return o.jsxs('div', {
          ...
          children: [
            o.jsx('div', { className: 'loading-spinner' }),
            o.jsx('div', {
      ...
      W.useEffect(() => {
        ...
        const N = () => {
          const O = new Date(_).getTime() + g * 1e3,
            Se = Date.now(),
            Pe = Math.max(0, Math.floor((O - Se) / 1e3));
          V(Pe);
        };
        return (
          N(),
          (M.current = setInterval(N, 1e3)),
          () => {
      ...
      const ge = (N) => {
          const T = new Date(N),
            O = new Date();
          return T.toDateString() === O.toDateString()
        ...
        ze = (N) => {
          var Se, Pe;
          const T = ((Se = N.model) == null ? void 0 : Se.toUpperCase()) || '',
            O =
              ((Pe = N.productType) == null ? void 0 : Pe.toLowerCase()) || '';
          return T.startsWith('MS') || O === 'switch'
            ? 'switch'
            : T.startsWith('MV') || O === 'camera'
            ? 'camera'
            : T.startsWith('MR') || O === 'wireless'
            ? 'wireless'
            : T.startsWith('MT') || O === 'sensor'
            ? 'sensor'
            : T.startsWith('MX') || T.startsWith('Z') || O === 'appliance'
            ? 'appliance'
            : 'all';
        },
        de = ((N) =>
          N.filter((T) => {
            ...
            return !(
              (h !== 'all' && ze(T) !== h) ||
              (x !== 'all' &&
                ((O = T.status) == null ? void 0 : O.toLowerCase()) !== x)
            );
          }))(c),
        Je = c.filter((N) => {
          var T;
              ...
              ((O = N.ports_statuses) == null
                ...
                : O.filter((He) => {
                    ...
                    return (
                      ((ln = He.status) == null
                        ? void 0
                        : ln.toLowerCase()) === 'connected'
                    );
                  }).length) || 0
            } ports active`;
          if (T === 'camera')
            return ((Se = N.status) == null ? void 0 : Se.toLowerCase()) ===
              'online'
              ? 'Recording'
              : 'Offline';
          if (T === 'wireless') return '— clients';
          if (T === 'sensor') {
            if (
              ((Pe = N.readings) == null ? void 0 : Pe.temperature) != null
            ) {
              const fe = N.readings.temperature,
                He =
                  s === 'fahrenheit'
                    ? ((fe * 9) / 5 + 32).toFixed(1)
                    : fe.toFixed(1),
                ln = s === 'fahrenheit' ? '°F' : '°C',
                Wl = N.readings.humidity ?? '--';
              return `${He}${ln} / ${Wl}%`;
            }
            return 'Active';
          }
        ...
        oe = (N) => de.filter((T) => T.networkId === N),
        $ = (N) => w.filter((T) => T.networkId === N),
        Ve = (N) => de.filter((T) => ze(T) === N),
        vt = async (N) => {
          if (!(!(n != null && n.callService) || !N.entity_id))
            try {
              await n.callService(
                'switch',
          ...
          o.jsxs('table', {
            ...
            children: [
              o.jsx('thead', {
                children: o.jsxs('tr', {
                  children: [
                    o.jsx('th', { children: 'Device' }),
                    o.jsx('th', { children: 'Model' }),
                    o.jsx('th', { children: 'Status' }),
                    o.jsx('th', { children: 'IP Address' }),
                    o.jsx('th', { children: 'Details' }),
                  ],
                }),
              }),
              o.jsxs('tbody', {
                        ...
                        children: [
                          ...
                          o.jsx('td', {
                            children: o.jsxs('div', {
                              ...
                              children: [
                                o.jsx('div', { className: 'status-dot' }),
                                o.jsx('span', {
      ...
      return o.jsxs('div', {
        children: [
          ...
          o.jsxs('div', {
            ...
            children: [
              o.jsx(Al, { title: 'Total Devices', value: c.length }),
              o.jsx(Al, { title: 'Online', value: Je, variant: 'success' }),
              o.jsx(Al, {
              ...
              o.jsx(Al, { title: 'Active SSIDs', value: z }),
            ],
          }),
          o.jsxs('div', {
            style: {
                ...
                children: [
                  o.jsx('button', {
                    ...
                    style: {
                      ...
                      border: 'none',
                      background:
                        S === 'network' ? 'var(--primary)' : 'transparent',
                      color:
                        S === 'network' ? 'white' : 'var(--text-secondary)',
                      cursor: 'pointer',
                      fontWeight: 500,
                      fontSize: '13px',
                    },
                  ...
                  o.jsx('button', {
                    ...
                    style: {
                      ...
                      border: 'none',
                      background:
                        S === 'type' ? 'var(--primary)' : 'transparent',
                      color: S === 'type' ? 'white' : 'var(--text-secondary)',
                      cursor: 'pointer',
                      fontWeight: 500,
                      fontSize: '13px',
                    },
            ...
            p.map((N) => {
              const T = oe(N.id),
                ...
                Se = T.filter((fe) => {
                  var He;
                  return (
                    ((He = fe.status) == null ? void 0 : He.toLowerCase()) ===
                    'online'
                  );
                }).length,
                Pe = a.has(N.id);
                      ...
                      children: [
                        o.jsxs('div', {
                          ...
                          children: [
                            ...
                            o.jsx('h2', { children: N.name }),
                            o.jsxs('span', {
                              className: 'badge',
                              children: [Se, '/', T.length, ' online'],
                            }),
                          ],
                        }),
                        o.jsx('span', {
                          className: `expand-icon ${Pe ? 'expanded' : ''}`,
                          children: '▼',
                        }),
                      ],
                    }),
                                      ...
                                      'div',
                                      {
                                        ...
                                        children: [
                                          ...
                                          o.jsx('div', {
                                            ...
                                            onClick: (He) => {
                                              He.stopPropagation(), vt(fe);
                                            },
                                          }),
                                        ],
                                      },
                                      `${fe.networkId}-${fe.number}`
                                    )
                                  ),
                                }),
                              ],
          ...
          S === 'type' &&
            jc
              ...
              .map((N) => {
                const T = Ve(N.value);
                if (T.length === 0 && h !== 'all') return null;
                const O = T.filter((Pe) => {
                    var fe;
                    return (
                      ((fe = Pe.status) == null
                        ? void 0
                        : fe.toLowerCase()) === 'online'
                    );
                  }).length,
                  Se = d.has(N.value);
                return o.jsxs(
                        ...
                        children: [
                          o.jsxs('div', {
                            ...
                            children: [
                              ...
                              o.jsx('h2', { children: N.label }),
                              o.jsxs('span', {
                                className: 'badge',
                                children: [O, '/', T.length, ' online'],
                              }),
                            ],
                          }),
                          o.jsx('span', {
                            className: `expand-icon ${Se ? 'expanded' : ''}`,
                            children: '▼',
                          }),
                        ],
                      }),
          ...
          de.length === 0 &&
            o.jsxs('div', {
              ...
              children: [
                o.jsx('div', { className: 'icon', children: '📡' }),
                o.jsx('h3', { children: 'No Devices Found' }),
                o.jsx('p', {
                  children:
                    h !== 'all' || x !== 'all'
    ...
    rp = ({ deviceName: e, model: t, ports: n }) => {
      var h, m, x, k, S, R, f, c, p, w, E;
      const [r, l] = W.useState(null),
        i = (g) =>
          g >= 1e6
            ? `${(g / 1e6).toFixed(1)} GB`
            : g >= 1e3
            ...
            : `${g} KB`,
        s = (g) =>
          g >= 1e3 ? `${(g / 1e3).toFixed(1)} Mbps` : `${g.toFixed(1)} Kbps`,
        a = (g) => {
          var _;
          return (
            ((_ = g.status) == null ? void 0 : _.toLowerCase()) === 'connected'
          );
        },
        u = (g) => {
          var _, L;
          return (
            ((_ = g.poe) == null ? void 0 : _.isAllocated) === !0 ||
            ((L = g.poe) == null ? void 0 : L.enabled) === !0
          );
        },
        d = n.filter(a).length,
        v = n.filter(u).length;
      return o.jsxs('div', {
        ...
        children: [
          o.jsxs('h3', {
            children: [o.jsx('span', { children: '⚡' }), ' Port Status'],
          }),
          o.jsxs('div', {
            ...
            children: [
              o.jsxs('div', {
                ...
                children: [
                  o.jsxs('div', {
                    ...
                    children: [
                      o.jsxs('span', { children: ['Cisco Meraki ', t] }),
                      o.jsxs('span', {
                        children: [d, ' of ', n.length, ' connected'],
                      }),
                    ],
                  }),
                  o.jsx('div', {
                    ...
                    children: n.map((g) =>
                      o.jsxs(
                        'div',
                        {
                          className: `port ${a(g) ? 'connected' : ''} ${
                            (r == null ? void 0 : r.portId) === g.portId
                              ? 'selected'
                              : ''
                          }`,
                          onClick: () => l(g),
              ...
              o.jsxs('div', {
                ...
                children: [
                  o.jsxs('span', {
                    children: [
                      o.jsx('div', { className: 'dot connected' }),
                      'Connected (',
                      d,
                      ')',
                    ],
                  ...
                  o.jsxs('span', {
                    children: [
                      o.jsx('div', { className: 'dot disconnected' }),
                      'Disconnected (',
                      n.length - d,
                      ')',
                    ],
                  }),
                  o.jsxs('span', { children: ['⚡ PoE Active (', v, ')'] }),
                ],
              }),
            ],
          }),
              ...
              children: [
                o.jsxs('h4', {
                  children: [
                    o.jsx('span', {
                      style: {
                        color: a(r) ? 'var(--success)' : 'var(--text-muted)',
                      },
                      children: '🔌',
                    }),
                    'Port ',
                ...
                (((h = r.errors) == null ? void 0 : h.length) ||
                  ((m = r.warnings) == null ? void 0 : m.length)) &&
                  o.jsxs('div', {
                    ...
                    children: [
                      ...
                      o.jsxs('div', {
                        ...
                        children: [
                          ...
                          o.jsx('div', {
                            className: 'mac',
                            children: r.clientMac || 'Unknown MAC',
                          }),
                        ],
                      }),
                    ],
                ...
                o.jsxs('div', {
                  ...
                  children: [
                    ...
                    o.jsxs('div', {
                      ...
                      children: [
                        ...
                        o.jsx('div', {
                          className: 'value',
                          children:
                            ((S = r.trafficInKbps) == null
                              ? void 0
                              : S.total) != null
                              ? s(r.trafficInKbps.total)
                              : '—',
                        }),
                      ],
                    }),
                    o.jsxs('div', {
                      ...
                      children: [
                        ...
                        o.jsx('div', {
                          className: 'value',
                          children:
                            ((R = r.usageInKb) == null ? void 0 : R.total) !=
                            null
                              ? i(r.usageInKb.total)
                              : '—',
                        }),
                    ...
                    o.jsxs('div', {
                      ...
                      children: [
                        ...
                        o.jsx('div', {
                          ...
                          children:
                            r.powerUsageInWh != null
                              ? `${r.powerUsageInWh.toFixed(1)} Wh`
                              : '—',
                        }),
                      ],
                    }),
                    o.jsxs('div', {
                      className: 'port-stat',
                      children: [
                        o.jsx('div', { className: 'label', children: 'VLAN' }),
                        o.jsx('div', {
                          className: 'value',
                          children: r.vlan || '—',
                        }),
                    ...
                    o.jsxs('div', {
                      ...
                      children: [
                        ...
                        o.jsx('div', {
                          className: 'value',
                          children: r.clientCount ?? '—',
                        }),
                      ],
                    }),
                  ],
                }),
                (((f = r.lldp) == null ? void 0 : f.systemName) ||
                  ((c = r.cdp) == null ? void 0 : c.deviceId)) &&
                  o.jsxs('div', {
                    style: {
                      marginTop: '16px',
                      padding: '12px',
                    ...
                    children: [
                      ...
                      ((p = r.lldp) == null ? void 0 : p.systemName) &&
                        o.jsxs('div', {
                            ...
                            r.lldp.portId &&
                              o.jsxs('div', {
                                ...
                                children: [
                                  ...
                                  r.lldp.portId,
                                  ' ',
                                  r.lldp.portDescription &&
                                    `(${r.lldp.portDescription})`,
                                ],
                              }),
                            r.lldp.managementAddress &&
                              o.jsx('div', {
                                style: {
                                  fontSize: '12px',
                                  color: 'var(--text-secondary)',
                                ...
                                children: r.lldp.managementAddress,
                              }),
                          ],
                        }),
                      ((w = r.cdp) == null ? void 0 : w.deviceId) &&
                        o.jsxs('div', {
                          children: [
                            o.jsx('div', {
                              style: {
                            ...
                            r.cdp.portId &&
                              o.jsxs('div', {
                                ...
                                children: ['Port: ', r.cdp.portId],
                              }),
                            r.cdp.managementAddress &&
                              o.jsx('div', {
                                style: {
                                  fontSize: '12px',
                                  color: 'var(--text-secondary)',
                                ...
                                children: r.cdp.managementAddress,
                              }),
                          ],
                        }),
                    ],
                  }),
                ((E = r.securePort) == null ? void 0 : E.enabled) &&
                  o.jsxs('div', {
                    style: {
                      marginTop: '12px',
                      fontSize: '13px',
                    ...
                    children: [
                      ...
                      o.jsxs('span', {
                        style: {
                          color: r.securePort.active
                            ? 'var(--success)'
                            : 'var(--text-muted)',
                        },
                        children: [
                          'SecurePort: ',
                          r.securePort.authenticationStatus ||
                            (r.securePort.active ? 'Active' : 'Inactive'),
                        ],
                      }),
                    ],
                  }),
    ...
    nn = ({
      ...
      const a = () => {
        ...
        v = () =>
          e === 'temperature' && s === 'fahrenheit' ? (t * 9) / 5 + 32 : t,
        h = () => {
          if (r !== void 0 && l !== void 0)
            return e === 'temperature' && s === 'fahrenheit'
              ? { min: (r * 9) / 5 + 32, max: (l * 9) / 5 + 32 }
              : { min: r, max: l };
          switch (e) {
            case 'temperature':
              return s === 'fahrenheit'
      ...
      return o.jsxs('div', {
        ...
        children: [
          ...
          o.jsx('div', { className: 'reading-label', children: u() }),
          o.jsxs('div', {
            className: 'reading-value',
            children: [
              typeof f == 'number' ? f.toFixed(1) : f,
              o.jsx('span', { className: 'reading-unit', children: S }),
            ],
          }),
          o.jsxs('div', {
            className: 'reading-status',
            children: [
              i === 'normal' && o.jsx('span', { children: '✅' }),
              i === 'warning' && o.jsx('span', { children: '⚠️' }),
              i === 'critical' && o.jsx('span', { children: '🚨' }),
              m(),
            ],
          }),
          o.jsx('div', {
          ...
          o.jsxs('div', {
            ...
            children: [
              o.jsxs('span', { children: [c.min.toFixed(0), S] }),
              o.jsxs('span', {
                children: [((c.max + c.min) / 2).toFixed(0), S],
              }),
              o.jsxs('span', { children: [c.max.toFixed(0), S] }),
            ],
          }),
        ],
      });
    ...
    lp = ({
      ...
      configEntryOptions: s,
    }) => {
      const a = (s == null ? void 0 : s.temperature_unit) || 'celsius',
        u = n.devices.find((y) => y.serial === e.deviceId),
        d = (n.clients || []).filter(
          (y) => y.recentDeviceSerial === (u == null ? void 0 : u.serial)
        ),
        [v, h] = Fe.useState(null),
        [m, x] = Fe.useState(!1),
        [k, S] = Fe.useState(null),
        [R, f] = Fe.useState([]),
        [c, p] = Fe.useState(''),
        [w, E] = Fe.useState(!1),
        [g, _] = Fe.useState(!1),
        [L, V] = Fe.useState(null),
        [M, ge] = Fe.useState(!1),
        ce = W.useRef(r);
      ce.current = r;
      const ze = W.useRef(null);
      if (!u)
        return o.jsxs('div', {
          children: [
            o.jsx('button', {
            ...
            o.jsxs('div', {
              ...
              children: [
                o.jsx('div', { className: 'icon', children: '❓' }),
                o.jsx('h3', { children: 'Device Not Found' }),
                o.jsx('p', {
      ...
      const {
        ...
        Nr = () => {
          const y = de.toUpperCase(),
            C = (U == null ? void 0 : U.toLowerCase()) || '';
          return y.startsWith('MS') || C === 'switch'
            ? '⚡'
            : y.startsWith('MV') || C === 'camera'
            ? '📹'
            : y.startsWith('MR') || C === 'wireless'
            ? '📶'
            : y.startsWith('MT') || C === 'sensor'
            ? '🌡️'
            : y.startsWith('MX') || y.startsWith('Z') || C === 'appliance'
            ? '🔒'
            : '📱';
        },
        N = () => {
        ...
        T = de.toUpperCase().startsWith('MS') || U === 'switch',
        O = de.toUpperCase().startsWith('MT') || U === 'sensor',
        Se = de.toUpperCase().startsWith('MV') || U === 'camera',
        Pe = de.toUpperCase().startsWith('MR') || U === 'wireless',
        fe = [
          'temperature',
          'humidity',
          'battery',
        ...
        He = At.filter((y) => {
          const C = y.name.toLowerCase(),
            re = y.entity_id.toLowerCase();
          return !fe.some((gt) => C.includes(gt) || re.includes(gt));
        }),
        ln = (y) => {
          if (!y) return '—';
          const C = Math.floor(y / 86400),
            re = Math.floor((y % 86400) / 3600);
          return `${C} days, ${re} hours`;
        },
        Wl = (y) => {
          if (!y) return 'Just now';
          const C = new Date(y),
            re = new Date();
          return C.toDateString() === re.toDateString()
        ...
        Ec = async () => {
          ...
          if (!(!y || !l || !u)) {
            x(!0);
            try {
              const C = await y.callWS({
                type: 'meraki_ha/get_camera_snapshot',
                config_entry_id: l,
                serial: u.serial,
              });
              C != null && C.url && h(C.url);
            } catch (C) {
              console.error('Failed to fetch snapshot:', C);
            } finally {
              x(!1);
            }
          }
        ...
        mp = async () => {
          ...
          if (!(!y || !l || !u))
            try {
              ...
              C != null && C.url && S(C.url);
            } catch (C) {
              console.error('Failed to fetch cloud video URL:', C);
            }
        },
        hp = () => {
        ...
        vp = async () => {
          ...
          if (y)
            try {
              ...
              C != null && C.cameras && f(C.cameras);
            } catch (C) {
              console.error('Failed to fetch available cameras:', C);
            }
        },
        gp = async () => {
          const y = ce.current;
          if (!(!y || !l || !u))
            try {
              ...
              C != null &&
                C.mappings &&
                C.mappings[u.serial] &&
                p(C.mappings[u.serial]);
            } catch (C) {
              console.error('Failed to fetch camera mappings:', C);
            }
        },
        xp = async (y) => {
          const C = ce.current;
          if (!(!C || !l || !u))
            try {
              await C.callWS({
                ...
                p(y),
                E(!1),
                g && y && (V(null), setTimeout(() => ns(), 100));
            } catch (re) {
              console.error('Failed to save camera mapping:', re);
            }
        },
        ns = async () => {
          const y = ce.current;
          if (!(!y || !c)) {
            ...
            try {
              ...
              C != null && C.path && V(C.path);
            } catch (C) {
              console.error('Failed to get signed camera URL:', C), V(null);
            } finally {
              ge(!1);
            }
          }
      ...
      Fe.useEffect(() => {
        ...
        const y =
            ...
            (((re = u.model) == null
              ? void 0
              : re.toUpperCase().startsWith('MV')) ||
              u.productType === 'camera'),
          C = u == null ? void 0 : u.serial;
        y &&
          C &&
          l &&
          ce.current &&
          ze.current !== C &&
          ((ze.current = C), Ec(), mp(), gp(), vp());
      }, [u == null ? void 0 : u.serial, l]),
        Fe.useEffect(() => {
          g && c && ce.current && ns();
        }, [g, c]);
      const yp = oe.filter((y) => {
          var C, re;
          return (
            ((C = y.poe) == null ? void 0 : C.isAllocated) ||
            ((re = y.poe) == null ? void 0 : re.enabled)
          );
        }),
        wp = oe.reduce((y, C) => y + (C.powerUsageInWh || 0), 0),
        kp = oe.reduce((y, C) => y + (C.clientCount || 0), 0);
      return o.jsxs('div', {
        children: [
          o.jsx('button', {
            onClick: () => t({ view: 'dashboard' }),
          ...
          o.jsxs('div', {
            ...
            children: [
              ...
              o.jsxs('div', {
                ...
                children: [
                  o.jsx('h1', { children: rn || Je }),
                  o.jsxs('div', {
                    className: 'meta',
                    children: [
                      o.jsxs('span', {
                        children: [
                          o.jsx('strong', { children: 'Model:' }),
                          ' ',
                          de,
                        ],
                      }),
                      ...
                      Ut &&
                        o.jsxs('span', {
                          children: [
                            o.jsx('strong', { children: 'Firmware:' }),
                            ' ',
                            Ut,
                          ],
                        }),
              ...
              o.jsxs('div', {
                ...
                children: [o.jsx('div', { className: 'dot' }), z || 'Unknown'],
              }),
            ],
          }),
          o.jsxs('div', {
            ...
            children: [
              o.jsxs('div', {
                className: 'info-card',
                children: [
                  o.jsx('h3', { children: 'ℹ️ Device Information' }),
                  o.jsxs('div', {
                    className: 'info-grid',
                    children: [
                      o.jsxs('div', {
                      ...
                      children: [
                        o.jsxs('div', {
                          ...
                          children: [
                            o.jsx('div', {
                              className: 'label',
                              children: 'PoE Energy Used',
                            }),
                            o.jsxs('div', {
                              className: 'value warning',
                              children: [wp.toFixed(1), ' Wh'],
                            }),
                          ],
                        }),
                        o.jsxs('div', {
                        ...
                        o.jsxs('div', {
                          ...
                          children: [
                            o.jsx('div', {
                              className: 'label',
                              children: 'Active PoE Ports',
                            }),
                            o.jsxs('div', {
                              className: 'value',
                              children: [yp.length, ' of ', oe.length],
                            }),
                          ],
                        }),
                        o.jsxs('div', {
                          ...
                          children: [
                            o.jsx('div', {
                              className: 'label',
                              children: 'Connected Ports',
                            }),
                            o.jsx('div', {
                              className: 'value success',
                              children: oe.filter((y) => {
                                var C;
                                return (
                                  ((C = y.status) == null
                                    ? void 0
                                    : C.toLowerCase()) === 'connected'
                                );
                              }).length,
                            }),
                          ],
              ...
              O &&
                ...
                o.jsxs('div', {
                  className: 'info-card',
                  children: [
                    o.jsx('h3', { children: '🔋 Sensor Status' }),
                    o.jsxs('div', {
                      className: 'info-grid',
                      children: [
                        o.jsxs('div', {
          ...
          T &&
            oe.length > 0 &&
            o.jsx(rp, { deviceName: rn || Je, model: de, ports: oe }),
          O &&
            $ &&
            o.jsxs('div', {
          ...
          Z.length > 0 &&
            o.jsxs('div', {
              ...
              children: [
                o.jsx('h3', { children: '⚠️ Status Messages' }),
                o.jsx('ul', {
                  style: {
                    margin: 0,
                    paddingLeft: '20px',
                  ...
                  children: Z.map((y, C) =>
                    o.jsx(
                      'li',
                      { style: { marginBottom: '8px' }, children: y },
                      C
                    )
                  ),
                }),
          ...
          He.length > 0 &&
            o.jsxs('div', {
              className: 'info-card',
              children: [
                o.jsxs('h3', { children: ['🔗 Entities (', He.length, ')'] }),
                o.jsxs('table', {
                  className: 'device-table',
                  children: [
                    o.jsx('thead', {
                      children: o.jsxs('tr', {
                        children: [
                          ...
                          o.jsx('th', { children: 'Entity ID' }),
                          o.jsx('th', { children: 'State' }),
                        ],
                      }),
                    }),
                    o.jsx('tbody', {
                      children: He.map((y) =>
                        o.jsxs(
                          ...
                          {
                            className: 'device-row',
                            onClick: () => _c(y.entity_id),
                            children: [
                              o.jsx('td', { children: y.name }),
                              o.jsx('td', {
                                style: {
                                  fontFamily: 'monospace',
                                  fontSize: '13px',
                ...
                o.jsxs('table', {
                  ...
                  children: [
                    o.jsx('thead', {
                      children: o.jsxs('tr', {
                        children: [
                          o.jsx('th', { children: 'Client' }),
                          o.jsx('th', { children: 'IP Address' }),
                          o.jsx('th', { children: 'Connection' }),
                        ],
                      }),
                    }),
                    o.jsx('tbody', {
                      children: d.slice(0, 10).map((y) => {
                        var C, re, gt;
                        return o.jsxs(
                          'tr',
                          {
                                ...
                                children: o.jsxs('div', {
                                  ...
                                  children: [
                                    o.jsx('span', {
                                      ...
                                      children:
                                        ((C = y.os) != null &&
                                          C.toLowerCase().includes('ios')) ||
                                        ((re = y.manufacturer) != null &&
                                          re.toLowerCase().includes('apple'))
                                          ? '📱'
                                          : (gt = y.os) != null &&
                                            gt
                                              .toLowerCase()
                    ...
                    children: [
                      o.jsx('button', {
                        ...
                        style: {
                          ...
                          borderRadius: 'var(--radius-sm)',
                          border: 'none',
                          background: g ? 'transparent' : 'var(--primary)',
                          color: g ? 'var(--text-secondary)' : 'white',
                          cursor: 'pointer',
                          fontWeight: 500,
                          transition: 'all 0.2s',
                        },
                ...
                o.jsxs('div', {
                  ...
                  children: [
                    o.jsxs('p', {
                      ...
                      children: [
                        '💡 ',
                        o.jsx('strong', { children: 'RTSP Streaming:' }),
          ...
          Pe &&
            o.jsxs('div', {
              className: 'info-card',
              children: [
                o.jsx('h3', { children: '📶 Wireless Access Point' }),
                u.basicServiceSets && u.basicServiceSets.length > 0
                  ? o.jsxs('div', {
                      children: [
                        o.jsxs('table', {
                          className: 'device-table',
                          ...
                          children: [
                            o.jsx('thead', {
                              children: o.jsxs('tr', {
                                children: [
                                  o.jsx('th', { children: 'SSID' }),
                                  o.jsx('th', { children: 'Band' }),
                                  o.jsx('th', { children: 'Channel' }),
                                  o.jsx('th', { children: 'Width' }),
                                  o.jsx('th', { children: 'Power' }),
                                  o.jsx('th', { children: 'Status' }),
                                ],
                              }),
                            }),
                            o.jsx('tbody', {
                              children: u.basicServiceSets
                                .filter((y) => y.enabled)
                                .map((y, C) => {
                                  var re, gt;
                                  return o.jsxs(
                                            ...
                                            children: [
                                              o.jsx('span', {
                                                style: {
                                                  ...
                                                  height: '8px',
                                                  borderRadius: '50%',
                                                  background: y.broadcasting
                                                    ? 'var(--success)'
                                                    : 'var(--text-muted)',
                                                  boxShadow: y.broadcasting
                                                    ? '0 0 8px var(--success)'
                                                    : 'none',
                                                },
                                              }),
                        ...
                        u.basicServiceSets.filter((y) => !y.enabled).length >
                          0 &&
                          o.jsxs('div', {
                            style: {
                              marginTop: '12px',
                            ...
                            children: [
                              u.basicServiceSets.filter((y) => !y.enabled)
                                .length,
    ...
    ip = ({ clients: e, setActiveView: t, onBack: n }) => {
      var h;
      const [r, l] = W.useState(''),
        [i, s] = W.useState(null),
        a = e.filter((m) => {
          var k, S, R, f, c, p;
          const x = r.toLowerCase();
          return (
            ((k = m.description) == null
              ? void 0
              : k.toLowerCase().includes(x)) ||
            ((S = m.mac) == null ? void 0 : S.toLowerCase().includes(x)) ||
            ((R = m.ip) == null ? void 0 : R.toLowerCase().includes(x)) ||
            ((f = m.manufacturer) == null
              ? void 0
              : f.toLowerCase().includes(x)) ||
            ((c = m.user) == null ? void 0 : c.toLowerCase().includes(x)) ||
            ((p = m.os) == null ? void 0 : p.toLowerCase().includes(x))
          );
        }),
        u = (m) => {
          if (m === 0) return '0 B';
          const x = 1024,
            k = ['B', 'KB', 'MB', 'GB', 'TB'],
            S = Math.floor(Math.log(m) / Math.log(x));
          return parseFloat((m / Math.pow(x, S)).toFixed(2)) + ' ' + k[S];
        },
        d = (m) => (m ? new Date(m).toLocaleString() : '—'),
        v = (m) => {
          var S, R;
          const x = ((S = m.os) == null ? void 0 : S.toLowerCase()) || '',
            k =
              ((R = m.manufacturer) == null ? void 0 : R.toLowerCase()) || '';
          return x.includes('ios') ||
            k.includes('apple') ||
            x.includes('android')
            ? '📱'
            : x.includes('windows')
        ...
        ? o.jsxs('div', {
            children: [
              ...
              o.jsxs('div', {
                className: 'device-header',
                children: [
                  o.jsx('div', { className: 'device-icon', children: v(i) }),
                  o.jsxs('div', {
                    className: 'device-info',
                    children: [
                      o.jsx('h1', { children: i.description || i.mac }),
                      o.jsxs('div', {
                        className: 'meta',
                        children: [
                          o.jsxs('span', {
                            children: [
                              o.jsx('strong', { children: 'MAC:' }),
                              ' ',
                              i.mac,
                            ],
                          }),
                          ...
                          i.manufacturer &&
                            o.jsxs('span', {
                              children: [
                                o.jsx('strong', { children: 'Manufacturer:' }),
                                ' ',
                                i.manufacturer,
                              ],
                            }),
                  ...
                  o.jsxs('div', {
                    className: `status-pill ${
                      ((h = i.status) == null ? void 0 : h.toLowerCase()) ||
                      'online'
                    }`,
                    children: [
                      o.jsx('div', { className: 'dot' }),
                      i.status || 'Online',
                    ],
                  }),
                ],
              ...
              o.jsxs('div', {
                ...
                children: [
                  o.jsxs('div', {
                    className: 'info-card',
                    children: [
                      o.jsx('h3', { children: '📋 Client Information' }),
                      o.jsxs('div', {
                        className: 'info-grid',
                        children: [
                          o.jsxs('div', {
                  ...
                  o.jsxs('div', {
                    className: 'info-card',
                    children: [
                      o.jsx('h3', { children: '🌐 Network Information' }),
                      o.jsxs('div', {
                        className: 'info-grid',
                        children: [
                          o.jsxs('div', {
                  ...
                  o.jsxs('div', {
                    className: 'info-card',
                    children: [
                      o.jsx('h3', { children: '📊 Usage Statistics' }),
                      o.jsxs('div', {
                        className: 'info-grid',
                        children: [
                          o.jsxs('div', {
                            ...
                            children: [
                              ...
                              o.jsx('div', {
                                className: 'value success',
                                children: i.usage ? u(i.usage.sent) : '—',
                              }),
                            ],
                          }),
                          o.jsxs('div', {
                            ...
                            children: [
                              ...
                              o.jsx('div', {
                                className: 'value primary',
                                children: i.usage ? u(i.usage.recv) : '—',
                              }),
                            ],
                          }),
                          o.jsxs('div', {
                  ...
                  o.jsxs('div', {
                    className: 'info-card',
                    children: [
                      o.jsx('h3', { children: '🔗 Connected To' }),
                      o.jsxs('div', {
                        className: 'info-grid',
                        children: [
                          o.jsxs('div', {
              ...
              o.jsxs('div', {
                ...
                children: [
                  ...
                  o.jsxs('div', {
                    className: 'device-info',
                    children: [
                      o.jsx('h1', { children: 'Connected Clients' }),
                      o.jsx('div', {
                        className: 'meta',
                        children: o.jsxs('span', {
                    ...
                    o.jsx('thead', {
                      children: o.jsxs('tr', {
                        children: [
                          o.jsx('th', { children: 'Client' }),
                          o.jsx('th', { children: 'IP Address' }),
                          o.jsx('th', { children: 'MAC Address' }),
                          o.jsx('th', { children: 'Manufacturer' }),
                          o.jsx('th', { children: 'SSID / Port' }),
                          o.jsx('th', { children: 'Usage' }),
                        ],
                      }),
                    }),
                    o.jsxs('tbody', {
  ...
  function ap(e) {
    ...
    try {
      if (window.parent && window.parent !== window) {
        const n = getComputedStyle(window.parent.document.documentElement)
          .getPropertyValue(e)
          .trim();
        if (n) return n;
      }
  ...
  function up(e) {
    const t = e ? op : sp,
      n = {};
    for (const [r, l] of Object.entries(t)) n[r] = ap(r) || l;
    return n;
  }
  function cp(e) {
    var l;
    const t =
      ...
      r = W.useMemo(() => {
        const i = {};
        for (const [s, a] of Object.entries(n)) i[s] = a;
        return (
          (i['--text-primary'] = n['--primary-text-color']),
          (i['--text-secondary'] = n['--secondary-text-color']),
          (i['--text-muted'] = n['--disabled-text-color']),
          (i['--bg-primary'] = n['--primary-background-color']),
          (i['--bg-secondary'] = n['--secondary-background-color']),
          (i['--card-bg'] = n['--card-background-color']),
          (i['--card-border'] = n['--divider-color']),
          (i['--primary'] = n['--primary-color']),
          (i['--success'] = n['--success-color']),
          (i['--warning'] = n['--warning-color']),
          (i['--error'] = n['--error-color']),
          i
        );
      }, [n]);
    return (
      W.useEffect(() => {
        ...
        for (const [s, a] of Object.entries(n)) i.style.setProperty(s, a);
        i.style.setProperty('--text-primary', n['--primary-text-color']),
          i.style.setProperty('--text-secondary', n['--secondary-text-color']),
          i.style.setProperty('--text-muted', n['--disabled-text-color']),
          i.style.setProperty('--bg-primary', n['--primary-background-color']),
          i.style.setProperty(
            '--bg-secondary',
            n['--secondary-background-color']
          ),
          i.style.setProperty('--card-bg', n['--card-background-color']),
          i.style.setProperty('--card-border', n['--divider-color']),
          i.style.setProperty('--primary', n['--primary-color']),
          i.style.setProperty('--success', n['--success-color']),
          i.style.setProperty('--warning', n['--warning-color']),
          i.style.setProperty('--error', n['--error-color']);
      }, [n]),
      { isDarkMode: t, themeVars: n, style: r }
    );
  }
  const Nc = () =>
      o.jsxs('div', {
    ...
    dp = ({ message: e, onRetry: t }) =>
      o.jsxs('div', {
        className: 'error-container',
        children: [
          o.jsx('span', { className: 'error-icon', children: '⚠️' }),
          o.jsxs('div', {
    ...
    $l = ({ version: e }) =>
      o.jsxs('div', {
        ...
        children: [
          ...
          o.jsx('h1', { children: 'Meraki Dashboard' }),
          e && o.jsxs('span', { className: 'version', children: ['v', e] }),
        ],
      }),
    fp = ({ hass: e, panel: t, narrow: n }) => {
      var p, w;
      const [r, l] = W.useState(null),
        [i, s] = W.useState(!0),
        [a, u] = W.useState(null),
        [d, v] = W.useState({ view: 'dashboard' }),
        { style: h } = cp(e),
        m = W.useRef(e);
      m.current = e;
      const x = W.useRef(!1),
        k =
          (p = t == null ? void 0 : t.config) == null
            ? void 0
            : p.config_entry_id,
        S = W.useCallback(async () => {
          ...
          if (!(!E || !k)) {
            s(!0), u(null);
            try {
              const g = await E.callWS({
                type: 'meraki_ha/get_config',
                config_entry_id: k,
              });
              if (g.networks && g.enabled_networks) {
                const _ = g.networks.map((L) => ({
                  ...L,
                  is_enabled: g.enabled_networks.includes(L.id),
                }));
                g.networks = _;
              }
              l(g), (x.current = !0);
            } catch (g) {
              console.error('Failed to fetch Meraki data:', g),
                u(
                  g instanceof Error
                    ? g.message
      ...
      if (i)
        return o.jsxs('div', {
          className: 'meraki-panel',
          style: h,
          children: [o.jsx($l, {}), o.jsx(Nc, {})],
        });
      if (a)
        return o.jsxs('div', {
          className: 'meraki-panel',
          style: h,
          children: [o.jsx($l, {}), o.jsx(dp, { message: a, onRetry: S })],
        });
      if (!r)
        return o.jsxs('div', {
          className: 'meraki-panel',
          ...
          children: [
            ...
            o.jsxs('div', {
              ...
              children: [
                o.jsx('div', { className: 'icon', children: '📡' }),
                o.jsx('h3', { children: 'No Data Available' }),
                o.jsx('p', {
          ...
          switch (d.view) {
            ...
            case 'device':
              return o.jsx(lp, {
                ...
                hass: e,
                configEntryId: k,
                cameraLinkIntegration: r.camera_link_integration,
                configEntryOptions: { temperature_unit: r.temperature_unit },
              });
            default:
              return o.jsx(np, {
                data: f,
                setActiveView: v,
                hass: e,
                defaultViewMode: r.dashboard_view_mode,
                defaultDeviceTypeFilter: r.dashboard_device_type_filter,
                defaultStatusFilter: r.dashboard_status_filter,
  ...
  class pp extends HTMLElement {
    constructor() {
      ...
      $t(this, '_route', null);
      $t(this, '_root', null);
      $t(this, '_mountPoint', null);
      $t(this, '_styleEl', null);
    }
    connectedCallback() {
      if (
        ((this._styleEl = document.createElement('style')),
        (this._styleEl.textContent = Cc),
        this.appendChild(this._styleEl),
        !document.getElementById('meraki-panel-styles'))
      ) {
        const n = document.createElement('style');
        (n.id = 'meraki-panel-styles'),
          (n.textContent = Cc),
      ...
      (this._mountPoint = document.createElement('div')),
        ...
        (this._root = Kl.createRoot(this._mountPoint)),
        this._render();
    }
    ...
    set narrow(n) {
      (this._narrow = n), this._render();
    }
    get narrow() {
      return this._narrow;
    }
    set route(n) {
      (this._route = n), this._render();
    }
    get route() {
      return this._route;
    }
  ...
  customElements.get('meraki-panel') ||
    customElements.define('meraki-panel', pp);
})();
