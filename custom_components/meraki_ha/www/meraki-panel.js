      ...
      e: for (var W = 0, G = x.length, bt = G >>> 1; W < bt; ) {
        ...
        if (0 > l(gl, T))
          gn < G && 0 > l(er, gl)
            ? ((x[W] = er), (x[gn] = T), (W = gn))
            : ((x[W] = gl), (x[yn] = T), (W = yn));
        else if (gn < G && 0 > l(er, T)) (x[W] = er), (x[gn] = T), (W = gn);
        else break e;
      }
    }
    return z;
...
var St =
  ...
  Bf = new Set(
    'cancel close invalid load scroll toggle'.split(' ').concat(St)
  );
function su(e, n, t) {
    ...
    if (!(n & 7)) {
      ...
      N &&
        ...
        0 < _.length &&
          ...
          C ? (N.data = C) : ((C = Fs(t)), C !== null && (N.data = C)))),
        (C = Pf ? zf(e, t) : Tf(e, t)) &&
...
function au(e, n, t, r, l) {
  for (var i = n._reactName, o = []; t !== null && t !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = Mt(t, i)), s != null && o.unshift(At(t, s, u)))
        : l || ((s = Mt(t, i)), s != null && o.push(At(t, s, u)))),
      (t = t.return);
  }
...
function ta(e) {
  ...
  function g(f, a, d, v, E) {
    ...
    if (typeof v == 'object' && v !== null) {
      switch (v.$$typeof) {
        case tr:
          return (
            (f = f.get(v.key === null ? d : v.key) || null), s(a, f, v, E)
          );
        case On:
          return (
            (f = f.get(v.key === null ? d : v.key) || null), c(a, f, v, E)
          );
        case Ze:
          var _ = v._init;
  ...
  function w(f, a, d, v) {
    for (
      var E = null, _ = null, C = a, N = (a = 0), H = null;
      C !== null && N < d.length;
      N++
    ) {
  ...
  function k(f, a, d, v) {
    ...
    for (
      var _ = (E = null), C = a, N = (a = 0), H = null, R = d.next();
      C !== null && !R.done;
      N++, R = d.next()
    ) {
      C.index > N ? ((H = C), (C = null)) : (H = C.sibling);
    ...
    if (R.done) return t(f, C), U && wn(f, N), E;
    if (C === null) {
...
function nd(e, n, t) {
  ...
  if (xa(e)) _a(n, l);
    ...
    (t = la(e, n, l, r)),
      t !== null && ((l = oe()), je(t, e, r, l), Ca(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
  ...
  td = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        ...
        Cr(4194308, 4, ya.bind(null, n, e), t)
      );
    },
...
function _u(e, n, t) {
  ...
  if (r === null) {
    ...
    (l = r.get(n)),
      l === void 0 && ((l = /* @__PURE__ */ new Set()), r.set(n, l));
...
function ud(e, n, t, r, l, i, o) {
  ...
  if (l.data === '$!') {
    ...
    return (
      (r = u), (i = Error(y(419))), (r = Vl(i, r, void 0)), mr(e, n, o, r)
    );
  }
        ...
        (e === null || e.child === null) &&
          (dr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Le !== null && (Fi(Le), (Le = null)))),
        Ti(e, n),
        te(n),
        null
      );
...
function dd(e, n) {
  ...
  for (
    mi = { focusedElem: e, selectionRange: t }, Dr = !1, S = n;
    S !== null;
...
function Po() {
  (X === 0 || X === 3 || X === 2) && (X = 4),
    J === null || (!(Tn & 268435455) && !(cl & 268435455)) || be(J, b);
}
function qr(e, n) {
  var t = j;
  j |= 2;
  ...
  if (tn !== null) {
    ...
    try {
      if (((xe.transition = null), (M = 16 > e ? 16 : e), tn === null))
        ...
        if (
          ((j = l), vn(), Fe && typeof Fe.onPostCommitFiberRoot == 'function')
        )
          try {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zi(n, t | 1), pe(n, Q()), !(j & 6) && ((lt = Q() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ys = Co;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, $n, il, hs, vs, Co] },
  yt = {
...
const Rd = () =>
    /* @__PURE__ */ P.jsx('div', {
      ...
      children: /* @__PURE__ */ P.jsx('h1', {
        children: 'Meraki Integration Control',
      }),
    }),
  jd = (e) =>
    e.startsWith('GS')
  ...
  Od = ({ devices: e }) => {
    if (!e || e.length === 0)
      return /* @__PURE__ */ P.jsx('p', {
        children: 'No devices found in this network.',
      });
                ...
                /* @__PURE__ */ P.jsxs(
                  'div',
                  {
                    ...
                    children: [
                      /* @__PURE__ */ P.jsx('p', {
                        style: { margin: 0 },
                        children: /* @__PURE__ */ P.jsx('strong', {
                          onClick: () =>
                            l.entity_id &&
  ...
  Dd = ({ data: e, onToggle: n }) => {
    const [t, r] = en.useState(null),
      l = (u) => {
        r(t === u ? null : u);
      },
      { networks: i, devices: o } = e;
    return !i || i.length === 0
      ? /* @__PURE__ */ P.jsx('p', { children: 'No networks found.' })
      : /* @__PURE__ */ P.jsx('div', {
          style: { display: 'flex', flexDirection: 'column', gap: '16px' },
          children: i.map((u) => {
            const s = t === u.id;
                  ...
                  /* @__PURE__ */ P.jsxs('div', {
                    ...
                    children: [
                      /* @__PURE__ */ P.jsxs('span', {
                        children: ['[Network] ', u.name],
                      }),
                      /* @__PURE__ */ P.jsx('ha-icon', {
  ...
  Fd = ({ hass: e, config_entry_id: n }) => {
    const [t, r] = en.useState(null),
      [l, i] = en.useState(!0),
      [o, u] = en.useState(null);
    en.useEffect(() => {
      if (!e || !e.connection) {
      ...
      (async () => {
        try {
          ...
          console.error('Error fetching Meraki data:', h),
            u(`Failed to fetch Meraki data: ${h.message || 'Unknown error'}`);
        } finally {
          i(!1);
        }
      })();
    ...
    const s = async (c, h) => {
      if (!t) return;
      const m = h
          ? [...t.enabled_networks, c]
          : t.enabled_networks.filter((g) => g !== c),
        p = t.networks.map((g) => (g.id === c ? { ...g, is_enabled: h } : g));
      r({
        ...t,
        networks: p,
        enabled_networks: m,
    ...
    return /* @__PURE__ */ P.jsxs('div', {
      children: [
        ...
        o && /* @__PURE__ */ P.jsxs('p', { children: ['Error: ', o] }),
        !l &&
          !o &&
          t &&
          /* @__PURE__ */ P.jsxs(P.Fragment, {
            children: [
              ...
              /* @__PURE__ */ P.jsx('ha-card', {
                header: 'Event Log',
                children: /* @__PURE__ */ P.jsx(Id, {}),
              }),
              /* @__PURE__ */ P.jsx('div', {
                style: { textAlign: 'center', marginTop: '16px' },
                children: /* @__PURE__ */ P.jsxs('p', {
                  children: ['Version: ', t.version],
                }),
              }),
            ],
          }),
...
class Ud extends HTMLElement {
  connectedCallback() {
    ...
    Ql.createRoot(t).render(
      /* @__PURE__ */ P.jsx(gc.StrictMode, {
        children: /* @__PURE__ */ P.jsx(Fd, { hass: r, config_entry_id: l }),
      })
    );
  }
}
customElements.get('meraki-panel') ||
  customElements.define('meraki-panel', Ud);
