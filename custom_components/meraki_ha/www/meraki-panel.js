 ...
 */ (function (e) {
  ...
  function r(S) {
    ...
    if (z !== P) {
      S[0] = z;
      e: for (var Q = 0, K = S.length, Zn = K >>> 1; Q < Zn; ) {
        var gt = 2 * (Q + 1) - 1,
          ya = S[gt],
          bt = gt + 1,
          er = S[bt];
  ...
  function _(S, P) {
    ...
    try {
      ...
      if (h !== null) var Zn = !0;
        ...
        var gt = n(c);
        gt !== null && ba(y, gt.startTime - P), (Zn = !1);
      }
      return Zn;
    } finally {
      (h = null), (p = z), (w = !1);
...
function hu() {
  if (Ht) {
    var e = Ht,
      t = qt;
    if (((qt = Ht = null), Wo(e), t)) for (e = 0; e < t.length; e++) Wo(t[e]);
  }
}
function gu(e, t) {
  return e(t);
...
function Fc(e, t, n, r, a, l, o, u, i) {
  (Sn = !1), (Tr = null), Rc.apply(Dc, arguments);
}
...
function Zc(e, t, n, r, a) {
  switch (t) {
    ...
    case 'gotpointercapture':
      return (
        (l = a.pointerId), On.set(l, fn(On.get(l) || null, e, t, n, r, a)), !0
      );
  }
  return !1;
}
...
function Rn(e) {
  ...
  for (; 0 < Ze.length && ((n = Ze[0]), n.blockedOn === null); )
    Tu(n), n.blockedOn === null && Ze.shift();
}
...
function Gl(e, t, n, r) {
  if (Or) {
    var a = cl(e, t, n, r);
    if (a === null) Ia(e, t, r, Rr, n), Ho(e, r);
    else if (Zc(a, e, t, n, r)) r.stopPropagation();
    else if ((Ho(e, r), t & 4 && -1 < Jc.indexOf(e))) {
      for (; a !== null; ) {
        var l = Gn(a);
        if (
          (l !== null && Cu(l),
...
function Fn(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var a = n[r];
    if (!Ha.call(t, a) || !Ie(e[a], t[a])) return !1;
  }
  return !0;
}
function ri(e) {
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      nu.forEach(function (n) {
        n !== 'selectionchange' && (Vd.has(n) || ja(n, !1, e), ja(n, !0, e));
      });
    var t = e.nodeType === 9 ? e : e.ownerDocument;
    t === null || t[cr] || ((t[cr] = !0), ja('selectionchange', !1, t));
  }
}
function Ku(e, t, n, r) {
  switch (Mu(t)) {
        ...
        for (var s = c, d; s !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              ...
              ((d = y),
              f !== null &&
                ((y = jn(s, f)), y != null && k.push(An(s, y, d)))),
            M)
          )
            break;
          s = s.return;
...
function ui(e, t, n, r, a) {
  for (var l = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = c),
      a
        ? ((i = jn(n, l)), i != null && o.unshift(An(n, i, u)))
        : a || ((i = jn(n, l)), i != null && o.push(An(n, i, u)))),
      (n = n.return);
  }
...
function ts(e) {
  ...
  function i(f, s, d, y) {
    var _ = d.type;
    return _ === It
      ? m(f, s, d.props.children, y, d.key)
      : s !== null &&
        (s.elementType === _ ||
          (typeof _ == 'object' &&
            _ !== null &&
            _.$$typeof === Ge &&
            gi(_) === s.type))
      ? ((y = a(s, d.props)), (y.ref = hn(f, s, d)), (y.return = f), y)
  ...
  function p(f, s, d, y) {
    ...
    if (typeof d == 'object' && d !== null) {
      ...
      if (vn(d) || cn(d)) return _ !== null ? null : m(f, s, d, y, null);
      pr(f, d);
    }
    return null;
  }
  function w(f, s, d, y, _) {
    ...
    if (typeof y == 'object' && y !== null) {
      ...
      if (vn(y) || cn(y)) return (f = f.get(d) || null), m(s, f, y, _, null);
      pr(s, y);
    }
    return null;
  }
...
function fo(e, t) {
  switch ((O(Wn, t), O($n, e), O(Ue, Jn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function ef(e, t, n) {
  ...
  if (xs(e)) Ss(t, a);
    ...
    (n = rs(e, t, a, r)),
      n !== null && ((a = ie()), je(n, e, r, a), _s(n, t, r));
  }
}
function xs(e) {
  var t = e.alternate;
...
function of(e, t, n, r, a, l, o) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Va(Error(b(422)))), mr(e, t, o, r))
      : t.memoizedState !== null
  ...
  if (a.data === '$!') {
    ...
    return (
      (r = u), (l = Error(b(419))), (r = Va(l, r, void 0)), mr(e, t, o, r)
    );
  }
  if (((u = (o & e.childLanes) !== 0), de || u)) {
    if (((r = G), r !== null)) {
      ...
      (a = a & (r.suspendedLanes | o) ? 0 : a),
        a !== 0 &&
          a !== l.retryLane &&
          ((l.retryLane = a), qe(e, a), je(r, e, a, -1));
    }
    return No(), (r = Va(Error(b(421)))), mr(e, t, o, r);
  }
  return a.data === '$?'
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function uf(e, t, n) {
  switch (t.tag) {
    ...
    case 10:
      ...
      O(Wr, r._currentValue), (r._currentValue = a);
      break;
    case 13:
        ...
        (e === null || e.child === null) &&
          (fr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Te !== null && (Rl(Te), (Te = null)))),
        zl(e, t),
        re(t),
        null
      );
    ...
    case 13:
      if (
        ...
        if (F && ge !== null && t.mode & 1 && !(t.flags & 128))
          ...
          re(t), (l = !1);
        } else Te !== null && (Rl(Te), (Te = null)), (l = !0);
...
function ff(e, t) {
  ...
  for (
    ml = { focusedElem: e, selectionRange: n }, Or = !1, x = t;
    x !== null;
...
function je(e, t, n, r) {
  if (50 < Ln) throw ((Ln = 0), (Il = null), Error(b(185)));
  Kn(e, n, r),
    (!(j & 2) || e !== G) &&
      (e === G && (!(j & 2) && (ca |= n), X === 4 && et(e, ee)),
      me(e, r),
      n === 1 && j === 0 && !(t.mode & 1) && ((rn = B() + 500), oa && ht()));
}
function me(e, t) {
...
function Ws(e, t) {
  if (((Cr = -1), (Pr = 0), j & 6)) throw Error(b(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = Jr(e, r);
    ...
    j |= 2;
    var l = Bs();
    (G !== e || ee !== t) && ((Ae = null), (rn = B() + 500), St(e, t));
    do
      try {
        bf();
        break;
    ...
    io(),
      (Kr.current = l),
      (j = a),
      H !== null ? (t = 0) : ((G = null), (ee = 0), (t = X));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((a = ul(e)), a !== 0 && ((r = a), (t = Ol(e, a)))), t === 1)
    )
      throw ((n = qn), St(e, 0), et(e, r), me(e, B()), n);
    if (t === 6) et(e, r);
    else {
      if (
  ...
  return me(e, B()), e.callbackNode === n ? Ws.bind(null, e) : null;
}
function Ol(e, t) {
  var n = zn;
  return (
...
function Di(e) {
  ...
  if (n === 1) throw ((n = qn), St(e, 0), et(e, t), me(e, B()), n);
...
function _o(e, t) {
  ...
  try {
    ...
    (j = n), j === 0 && ((rn = B() + 500), oa && ht());
  }
}
function zt(e) {
  nt !== null && nt.tag === 0 && !(j & 6) && Yt();
  var t = j;
  j |= 1;
  var n = _e.transition,
    r = I;
  try {
    ...
    (I = r), (_e.transition = n), (j = t), !(j & 6) && ht();
  }
}
function Eo() {
  (he = Qt.current), D(Qt);
...
function Jr(e, t) {
  ...
  while (!0);
  if ((io(), (j = n), (Kr.current = r), H !== null)) throw Error(b(261));
...
function vt(e, t, n) {
  var r = I,
    a = _e.transition;
  try {
    (_e.transition = null), (I = 1), yf(e, t, n, r);
  } finally {
    (_e.transition = a), (I = r);
  }
  return null;
...
function yf(e, t, n, r) {
  ...
  if (Yr) throw ((Yr = !1), (e = jl), (jl = null), e);
  return (
    Gr & 1 && e.tag !== 0 && Yt(),
    (l = e.pendingLanes),
    l & 1 ? (e === Il ? Ln++ : ((Ln = 0), (Il = e))) : (Ln = 0),
    ht(),
    null
  );
}
  ...
  if (nt !== null) {
    ...
    try {
      if (((_e.transition = null), (I = 16 > e ? 16 : e), nt === null))
        ...
        if (((e = nt), (nt = null), (Gr = 0), j & 6)) throw Error(b(331));
        var a = j;
        ...
        if (
          ((j = a), ht(), Fe && typeof Fe.onPostCommitFiberRoot == 'function')
        )
          try {
...
function vf(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    G === e &&
      (ee & n) === n &&
      (X === 4 || (X === 3 && (ee & 130023424) === ee && 500 > B() - So)
        ? St(e, 0)
        : (xo |= n)),
    me(e, t);
}
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Kl(t, n | 1), me(t, B()), !(j & 6) && ((rn = B() + 500), ht()));
      }
      break;
    case 13:
      zt(function () {
...
const Tf = ({ devices: e, setActiveView: t }) => {
  ...
  Of = ({ activeView: e, setActiveView: t, data: n }) => {
    ...
    return g.jsxs('div', {
      ...
      children: [
        ...
        o.view === 'dashboard'
          ...
          : g.jsx(Of, { activeView: o, setActiveView: u, data: e }),
        i &&
          e &&
          g.jsx(Rf, {
            options: e.options || {},
