 ...
 */
const Ct = globalThis, Jt = Ct.ShadowRoot && (Ct.ShadyCSS === void 0 || Ct.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Wt = Symbol(), se = /* @__PURE__ */ new WeakMap();
let ve = class {
  constructor(t, e, s) {
...
}, re = Jt ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ze, defineProperty: je, getOwnPropertyDescriptor: Ke, getOwnPropertyNames: Ge, getOwnPropertySymbols: qe, getPrototypeOf: Je } = Object, L = globalThis, oe = L.trustedTypes, We = oe ? oe.emptyScript : "", Rt = L.reactiveElementPolyfillSupport, rt = (i, t) => i, bt = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? We : null;
      break;
  ...
  return e;
} }, Yt = (i, t) => !ze(i, t), ae = { attribute: !0, type: String, converter: bt, reflect: !1, useDefault: !1, hasChanged: Yt };
...
let q = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, s) {
    const { get: n, set: r } = Ke(this.prototype, t) ?? { get() {
      return this[e];
    }, set(o) {
      this[e] = o;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(rt("properties"))) {
      const e = this.properties, s = [...Ge(e), ...qe(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const n of s) e.unshift(re(n));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ot = globalThis, ce = (i) => i, At = ot.trustedTypes, le = At ? At.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Ee = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, Ce = "?" + x, Ye = `<${Ce}>`, j = document, ct = () => j.createComment(""), lt = (i) => i === null || typeof i != "object" && typeof i != "function", Qt = Array.isArray, Qe = (i) => Qt(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Dt = `[
\f\r]`, st = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, he = /-->/g, ue = />/g, F = RegExp(`>|${Dt}(?:([^\\s"'>=/]+)(${Dt}*=${Dt}*(?:[^
\f\r"'\`<>=]|("|')|))|$)`, "g"), de = /'/g, fe = /"/g, be = /^(?:script|style|textarea|title)$/i, Ze = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), E = Ze(1), J = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), ge = /* @__PURE__ */ new WeakMap(), V = j.createTreeWalker(j, 129);
function Ae(i, t) {
...
const Xe = (i, t) => {
  ...
  for (let c = 0; c < e; c++) {
    const a = i[c];
    let l, h, f = -1, d = 0;
    for (; d < a.length && (o.lastIndex = d, h = o.exec(a), h !== null); ) d = o.lastIndex, o === st ? h[1] === "!--" ? o = he : h[1] !== void 0 ? o = ue : h[2] !== void 0 ? (be.test(h[2]) && (n = RegExp("</" + h[2], "g")), o = F) : h[3] !== void 0 && (o = F) : o === F ? h[0] === ">" ? (o = n ?? st, f = -1) : h[1] === void 0 ? f = -2 : (f = o.lastIndex - h[2].length, l = h[1], o = h[3] === void 0 ? F : h[3] === '"' ? fe : de) : o === fe || o === de ? o = F : o === he || o === ue ? o = st : (o = F, n = void 0);
    const u = o === F && i[c + 1].startsWith("/>") ? " " : "";
    r += o === st ? a + Ye : f >= 0 ? (s.push(l), a.slice(0, f) + Ee + a.slice(f) + x + u) : a + x + (f === -2 ? c : u);
  }
...
class ht {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const c = t.length - 1, a = this.parts, [l, h] = Xe(t, e);
    ...
    for (; (n = V.nextNode()) !== null && a.length < c; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const f of n.getAttributeNames()) if (f.endsWith(Ee)) {
          ...
          a.push({ type: 1, index: r, name: _[2], strings: u, ctor: _[1] === "." ? ei : _[1] === "?" ? ii : _[1] === "@" ? ni : Pt }), n.removeAttribute(f);
      ...
      } else if (n.nodeType === 8) if (n.data === Ce) a.push({ type: 2, index: r });
      else {
        let f = -1;
...
class ti {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (o === a.index) {
        let l;
        a.type === 2 ? l = new mt(r, r.nextSibling, this, t) : a.type === 1 ? l = new a.ctor(r, a.name, a.strings, this, t) : a.type === 6 && (l = new si(r, this, t)), this._$AV.push(l), a = s[++c];
      }
...
class mt {
  ...
  _$AI(t, e = this) {
    t = W(this, t, e), lt(t) ? t === P || t == null || t === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : t !== this._$AH && t !== J && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Qe(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    var r;
    const { values: e, _$litType$: s } = t, n = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = ht.createElement(Ae(s.h, s.h[0]), this.options)), s);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === n) this._$AH.p(e);
    else {
      const o = new ti(n, this), c = o.u(this.options);
      o.p(e), this.T(c), this._$AH = o;
    }
  }
  _$AC(t) {
    let e = ge.get(t.strings);
    return e === void 0 && ge.set(t.strings, e = new ht(t)), e;
  }
  k(t) {
...
class Pt {
  ...
  _$AI(t, e = this, s, n) {
    ...
    if (r === void 0) t = W(this, t, e, 0), o = !lt(t) || t !== this._$AH && t !== J, o && (this._$AH = t);
      ...
      const c = t;
      let a, l;
      for (t = r[0], a = 0; a < r.length - 1; a++) l = W(this, c[s + a], e, a), l === J && (l = this._$AH[a]), o || (o = !lt(l) || l !== this._$AH[a]), l === P ? t = P : t !== P && (t += (l ?? "") + r[a + 1]), this._$AH[a] = l;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
var we;
T._$litElement$ = !0, T.finalized = !0, (we = z.litElementHydrateSupport) == null || we.call(z, { LitElement: T });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const oi = { attribute: !0, type: String, converter: bt, reflect: !1, hasChanged: Yt }, ai = (i = oi, t, e) => {
...
function O(i) {
  return (t, e) => typeof e == "object" ? ai(i, t, e) : ((s, n, r) => {
...
var ci = Object.defineProperty, li = Object.getOwnPropertyDescriptor, et = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? li(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && ci(t, e, n), n;
};
...
Xt.prototype.initialize = function(t) {
  this.degree = t, this.genPoly = Te.generateECPolynomial(this.degree);
};
Xt.prototype.encode = function(t) {
  ...
  e.set(t);
  const s = Te.mod(e, this.genPoly), n = this.degree - s.length;
  if (n > 0) {
...
ft = ft.replace(/u/g, "\\u");
const mi = "(?:(?![A-Z0-9 $%*+\\-./:]|" + ft + `)(?:.|[\r
]))+`;
B.KANJI = new RegExp(ft, "g");
B.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
B.BYTE = new RegExp(mi, "g");
B.NUMERIC = new RegExp(Be, "g");
B.ALPHANUMERIC = new RegExp(_i, "g");
const yi = new RegExp("^" + ft + "$"), wi = new RegExp("^" + Be + "$"), vi = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
var Re = {};
const zt = N, De = 1335, Ei = 21522, _e = zt.getBCHDigit(De);
Re.getEncodedBits = function(t, e) {
  const s = t.bit << 3 | e;
  let n = s << 10;
  for (; zt.getBCHDigit(n) - _e >= 0; )
    n ^= De << zt.getBCHDigit(n) - _e;
  return (s << 10 | n) ^ Ei;
};
var xe = {};
const Ci = H;
function Y(i) {
  this.mode = Ci.NUMERIC, this.data = i.toString();
}
...
const ki = H, Ni = N;
function X(i) {
  this.mode = ki.KANJI, this.data = i;
}
...
var Ti = Ue.exports;
(function(i) {
  const t = H, e = bi, s = $i, n = Pi, r = Mi, o = B, c = N, a = Ti;
  function l(m) {
  ...
  function f(m) {
    ...
    let g, v;
    return c.isKanjiModeEnabled() ? (g = h(o.BYTE, t.BYTE, m), v = h(o.KANJI, t.KANJI, m)) : (g = h(o.BYTE_KANJI, t.BYTE, m), v = []), w.concat(p, g, v).sort(function(S, M) {
 ...
 Suggested mode is: ` + t.toString(g));
  ...
  i.fromArray = function(w) {
    ...
    const g = f(w, c.isKanjiModeEnabled()), v = _(g), C = y(v, p), S = a.find_path(C.map, "start", "end"), M = [];
    for (let D = 1; D < S.length - 1; D++)
      M.push(C.table[S[D]].node);
...
const Tt = N, Ot = kt, Ii = di, Bi = fi, Ri = Pe, Di = ke, jt = Ne, Kt = Nt, xi = pi, St = Ie, Ui = Re, Li = H, Ht = xe;
function Oi(i, t) {
...
function Ft(i, t, e) {
  const s = i.size, n = Ui.getEncodedBits(t, e);
  let r, o;
  for (r = 0; r < 15; r++)
...
function ji(i, t, e) {
  ...
  e.forEach(function(a) {
    s.put(a.mode.bit, 4), s.put(a.getLength(), Li.getCharCountIndicator(a.mode, i)), a.write(s);
  });
...
function Ki(i, t, e) {
  const s = Tt.getSymbolTotalCodewords(t), n = Kt.getTotalCodewordsCount(t, e), r = s - n, o = Kt.getBlocksCount(t, e), c = s % o, a = o - c, l = Math.floor(s / o), h = Math.floor(r / o), f = h + 1, d = l - h, u = new xi(d);
  let _ = 0;
  ...
  for (let S = 0; S < o; S++) {
    const M = S < a ? h : f;
    y[S] = w.slice(_, _ + M), k[S] = u.encode(y[S]), _ += M, m = Math.max(m, M);
  }
...
`
  ...
  const o = ji(t, e, n), c = Tt.getSymbolSize(t), a = new Bi(c);
  return Oi(a, t), Hi(a), Fi(a, t), Ft(a, e, 0), t >= 7 && Vi(a, t), zi(a, o), isNaN(s) && (s = jt.getBestMask(
    a,
    Ft.bind(null, a, e)
...
$e.create = function(t, e) {
  ...
  let s = Ot.M, n, r;
  return typeof e < "u" && (s = Ot.from(e.errorCorrectionLevel, Ot.M), n = St.from(e.version), r = jt.from(e.maskPattern), e.toSJISFunc && Tt.setToSJISFunction(e.toSJISFunc)), Gi(t, n, s, r);
};
var Le = {}, ee = {};
(function(i) {
  function t(e) {
...
Oe.render = function(t, e, s) {
  const n = qi.getOptions(e), r = t.modules.size, o = t.modules.data, c = r + n.margin * 2, a = n.color.light.a ? "<path " + me(n.color.light, "fill") + ' d="M0 0h' + c + "v" + c + 'H0z"/>' : "", l = "<path " + me(n.color.dark, "stroke") + ' d="' + Ji(o, r, n.margin) + '"/>', h = 'viewBox="0 0 ' + c + " " + c + '"', d = '<svg xmlns="http://www.w3.org/2000/svg" ' + (n.width ? 'width="' + n.width + '" height="' + n.width + '" ' : "") + h + ' shape-rendering="crispEdges">' + a + l + `</svg>
`;
  return typeof s == "function" && s(null, d), d;
};
const Wi = hi, Gt = $e, He = Le, Yi = Oe;
...
yt.create = Gt.create;
yt.toCanvas = ie.bind(null, He.render);
yt.toDataURL = ie.bind(null, He.renderToDataURL);
yt.toString = ie.bind(null, function(i, t, e) {
  return Yi.render(i, e);
});
var Qi = Object.defineProperty, Zi = Object.getOwnPropertyDescriptor, It = (i, t, e, s) => {
...
var Xi = Object.defineProperty, tn = Object.getOwnPropertyDescriptor, it = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? tn(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
...
var en = Object.defineProperty, nn = Object.getOwnPropertyDescriptor, $ = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? nn(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
...
$([
  b()
], A.prototype, "_selectedNetwork", 2);
$([
  b()
], A.prototype, "_selectedSSID", 2);
$([
  b()
], A.prototype, "_selectedPolicy", 2);
$([
  b()
], A.prototype, "_selectedDuration", 2);
$([
  b()
], A.prototype, "_customName", 2);
$([
  b()
], A.prototype, "_customPassphrase", 2);
$([
  b()
], A.prototype, "_creating", 2);
$([
  b()
...
$([
  b()
], A.prototype, "_networks", 2);
$([
  b()
], A.prototype, "_ssids", 2);
$([
  b()
], A.prototype, "_policies", 2);
$([
  b()
], A.prototype, "_loading", 2);
$([
  b()
], A.prototype, "_initDone", 2);
...
export {
  ...
  _t as MerakiGuestAccessCardEditor
};
