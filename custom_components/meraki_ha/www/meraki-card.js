 ...
 */
const G = globalThis, Q = G.ShadowRoot && (G.ShadyCSS === void 0 || G.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), nt = /* @__PURE__ */ new WeakMap();
let yt = class {
  constructor(t, e, i) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Et, defineProperty: kt, getOwnPropertyDescriptor: xt, getOwnPropertyNames: Ct, getOwnPropertySymbols: Pt, getPrototypeOf: Nt } = Object, v = globalThis, at = v.trustedTypes, Mt = at ? at.emptyScript : "", W = v.reactiveElementPolyfillSupport, M = (r, t) => r, L = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? Mt : null;
      break;
  ...
  return e;
} }, tt = (r, t) => !Et(r, t), ct = { attribute: !0, type: String, converter: L, reflect: !1, useDefault: !1, hasChanged: tt };
...
let k = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, i) {
    const { get: s, set: n } = xt(this.prototype, t) ?? { get() {
      return this[e];
    }, set(o) {
      this[e] = o;
    } };
  ...
  _$AK(t, e) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const c = i.getPropertyOptions(s), a = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((n = c.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? c.converter : L;
      this._$Em = s;
  ...
  requestUpdate(t, e, i, s = !1, n) {
    ...
    if (t !== void 0) {
      ...
      if (s === !1 && (n = this[t]), i ?? (i = c.getPropertyOptions(t)), !((i.hasChanged ?? tt)(n, e) || i.useDefault && i.reflect && n === ((o = this._$Ej) == null ? void 0 : o.get(t)) && !this.hasAttribute(c._$Eu(t, i)))) return;
      this.C(t, e, i);
    }
...
k.elementStyles = [], k.shadowRootOptions = { mode: "open" }, k[M("elementProperties")] = /* @__PURE__ */ new Map(), k[M("finalized")] = /* @__PURE__ */ new Map(), W == null || W({ ReactiveElement: k }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, lt = (r) => r, B = O.trustedTypes, ht = B ? B.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, $t = "$lit$", $ = `lit$${Math.random().toFixed(9).slice(2)}$`, vt = "?" + $, Ot = `<${vt}>`, E = document, D = () => E.createComment(""), T = (r) => r === null || typeof r != "object" && typeof r != "function", et = Array.isArray, Dt = (r) => et(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", q = `[
\f\r]`, N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, dt = /-->/g, ut = />/g, b = RegExp(`>|${q}(?:([^\\s"'>=/]+)(${q}*=${q}*(?:[^
\f\r"'\`<>=]|("|')|))|$)`, "g"), pt = /'/g, _t = /"/g, wt = /^(?:script|style|textarea|title)$/i, Tt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), _ = Tt(1), x = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), ft = /* @__PURE__ */ new WeakMap(), A = E.createTreeWalker(E, 129);
function bt(r, t) {
...
const Ut = (r, t) => {
  ...
  for (let c = 0; c < e; c++) {
    const a = r[c];
    let h, f, l = -1, m = 0;
    for (; m < a.length && (o.lastIndex = m, f = o.exec(a), f !== null); ) m = o.lastIndex, o === N ? f[1] === "!--" ? o = dt : f[1] !== void 0 ? o = ut : f[2] !== void 0 ? (wt.test(f[2]) && (s = RegExp("</" + f[2], "g")), o = b) : f[3] !== void 0 && (o = b) : o === b ? f[0] === ">" ? (o = s ?? N, l = -1) : f[1] === void 0 ? l = -2 : (l = o.lastIndex - f[2].length, h = f[1], o = f[3] === void 0 ? b : f[3] === '"' ? _t : pt) : o === _t || o === pt ? o = b : o === dt || o === ut ? o = N : (o = b, s = void 0);
    const y = o === b && r[c + 1].startsWith("/>") ? " " : "";
    n += o === N ? a + Ot : l >= 0 ? (i.push(h), a.slice(0, l) + $t + a.slice(l) + $ + y) : a + $ + (l === -2 ? c : y);
  }
...
class U {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    if (this.el = U.createElement(h, i), A.currentNode = this.el.content, e === 2 || e === 3) {
    ...
    for (; (s = A.nextNode()) !== null && a.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const l of s.getAttributeNames()) if (l.endsWith($t)) {
          const m = f[o++], y = s.getAttribute(l).split($), z = /([.?@])?(.*)/.exec(m);
          a.push({ type: 1, index: n, name: z[2], strings: y, ctor: z[1] === "." ? Ht : z[1] === "?" ? Rt : z[1] === "@" ? jt : K }), s.removeAttribute(l);
        ...
        if (wt.test(s.tagName)) {
          ...
          if (m > 0) {
            ...
            for (let y = 0; y < m; y++) s.append(l[y], D()), A.nextNode(), a.push({ type: 2, index: ++n });
            s.append(l[m], D());
          }
        }
...
function C(r, t, e = r, i) {
  ...
  return (s == null ? void 0 : s.constructor) !== n && ((c = s == null ? void 0 : s._$AO) == null || c.call(s, !1), n === void 0 ? s = void 0 : (s = new n(r), s._$AT(r, e, i)), i !== void 0 ? (e._$Co ?? (e._$Co = []))[i] = s : e._$Cl = s), s !== void 0 && (t = C(r, s._$AS(r, t.values), s, i)), t;
}
class It {
  constructor(t, e) {
...
class j {
  ...
  $(t) {
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === s) this._$AH.p(e);
      ...
      const o = new It(s, this), c = o.u(this.options);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let i, s = 0;
    for (const n of t) s === e.length ? e.push(i = new j(this.O(D()), this.O(D()), this, this.options)) : i = e[s], i._$AI(n), s++;
...
class K {
  ...
  _$AI(t, e = this, i, s) {
    ...
    let o = !1;
    if (n === void 0) t = C(this, t, e, 0), o = !T(t) || t !== this._$AH && t !== x, o && (this._$AH = t);
    else {
      const c = t;
      let a, h;
      for (t = n[0], a = 0; a < n.length - 1; a++) h = C(this, c[i + a], e, a), h === x && (h = this._$AH[a]), o || (o = !T(h) || h !== this._$AH[a]), h === u ? t = u : t !== u && (t += (h ?? "") + n[a + 1]), this._$AH[a] = h;
    }
    o && !s && this.j(t);
  }
  j(t) {
...
const zt = (r, t, e) => {
  ...
  if (s === void 0) {
    ...
    i._$litPart$ = s = new j(t.insertBefore(D(), n), n, void 0, e ?? {});
  }
  return s._$AI(r), s;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Gt = { attribute: !0, type: String, converter: L, reflect: !1, hasChanged: tt }, Lt = (r = Gt, t, e) => {
...
function V(r) {
  return (t, e) => typeof e == "object" ? Lt(r, t, e) : ((i, s, n) => {
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="profile-buttons">
            ${i.map((n) => _`
              <div
                class="profile-button ${e === n ? "active" : ""}"
                @click="${() => this._handleProfileSelect(n)}"
              >
...
let R = class extends w {
  ...
  _valueChanged(r) {
    ...
    const t = r.target, e = t.value, i = t.configValue;
    if (this._config[i] === e) return;
    const s = {
      ...this._config,
      [i]: e
