 ...
 */
const vt = globalThis, qt = vt.ShadowRoot && (vt.ShadyCSS === void 0 || vt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Jt = Symbol(), ne = /* @__PURE__ */ new WeakMap();
let we = class {
  constructor(t, e, s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ve, defineProperty: ze, getOwnPropertyDescriptor: je, getOwnPropertyNames: Ke, getOwnPropertySymbols: Ge, getPrototypeOf: qe } = Object, L = globalThis, re = L.trustedTypes, Je = re ? re.emptyScript : "", Bt = L.reactiveElementPolyfillSupport, st = (i, t) => i, Ct = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Je : null;
      break;
  ...
  return e;
} }, Wt = (i, t) => !Ve(i, t), oe = { attribute: !0, type: String, converter: Ct, reflect: !1, useDefault: !1, hasChanged: Wt };
...
let G = class extends HTMLElement {
  ...
  requestUpdate(t, e, s, n = !1, r) {
    ...
    if (t !== void 0) {
      ...
      if (n === !1 && (r = this[t]), s ?? (s = c.getPropertyOptions(t)), !((s.hasChanged ?? Wt)(r, e) || s.useDefault && s.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(t)) && !this.hasAttribute(c._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
G.elementStyles = [], G.shadowRootOptions = { mode: "open" }, G[st("elementProperties")] = /* @__PURE__ */ new Map(), G[st("finalized")] = /* @__PURE__ */ new Map(), Bt == null || Bt({ ReactiveElement: G }), (L.reactiveElementVersions ?? (L.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rt = globalThis, ae = (i) => i, bt = rt.trustedTypes, ce = bt ? bt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Ee = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, ve = "?" + x, We = `<${ve}>`, z = document, at = () => z.createComment(""), ct = (i) => i === null || typeof i != "object" && typeof i != "function", Yt = Array.isArray, Ye = (i) => Yt(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Rt = `[
\f\r]`, nt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, le = /-->/g, he = />/g, H = RegExp(`>|${Rt}(?:([^\\s"'>=/]+)(${Rt}*=${Rt}*(?:[^
\f\r"'\`<>=]|("|')|))|$)`, "g"), ue = /'/g, de = /"/g, Ce = /^(?:script|style|textarea|title)$/i, Qe = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), C = Qe(1), q = Symbol.for("lit-noChange"), S = Symbol.for("lit-nothing"), fe = /* @__PURE__ */ new WeakMap(), F = z.createTreeWalker(z, 129);
function be(i, t) {
...
const Ze = (i, t) => {
  ...
  for (let c = 0; c < e; c++) {
    ...
    r += o === nt ? a + We : f >= 0 ? (s.push(l), a.slice(0, f) + Ee + a.slice(f) + x + u) : a + x + (f === -2 ? c : u);
  }
    ...
    for (; (n = F.nextNode()) !== null && a.length < c; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const f of n.getAttributeNames()) if (f.endsWith(Ee)) {
          ...
          a.push({ type: 1, index: r, name: _[2], strings: u, ctor: _[1] === "." ? ti : _[1] === "?" ? ei : _[1] === "@" ? ii : St }), n.removeAttribute(f);
...
function J(i, t, e = i, s) {
  var o, c;
  if (t === q) return t;
  let n = s !== void 0 ? (o = e._$Co) == null ? void 0 : o[s] : e._$Cl;
  const r = ct(t) ? void 0 : t._$litDirective$;
  return (n == null ? void 0 : n.constructor) !== r && ((c = n == null ? void 0 : n._$AO) == null || c.call(n, !1), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = J(i, n._$AS(i, t.values), n, s)), t;
}
class Xe {
  constructor(t, e) {
...
class pt {
  ...
  _$AI(t, e = this) {
    t = J(this, t, e), ct(t) ? t === S || t == null || t === "" ? (this._$AH !== S && this._$AR(), this._$AH = S) : t !== this._$AH && t !== q && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ye(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== S && ct(this._$AH) ? this._$AA.nextSibling.data = t : this.T(z.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var r;
...
class St {
  ...
  _$AI(t, e = this, s, n) {
    ...
    let o = !1;
    if (r === void 0) t = J(this, t, e, 0), o = !ct(t) || t !== this._$AH && t !== q, o && (this._$AH = t);
    else {
      const c = t;
      let a, l;
      for (t = r[0], a = 0; a < r.length - 1; a++) l = J(this, c[s + a], e, a), l === q && (l = this._$AH[a]), o || (o = !ct(l) || l !== this._$AH[a]), l === S ? t = S : t !== S && (t += (l ?? "") + r[a + 1]), this._$AH[a] = l;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
const Dt = rt.litHtmlPolyfillSupport;
Dt == null || Dt(lt, pt), (rt.litHtmlVersions ?? (rt.litHtmlVersions = [])).push("3.3.2");
const si = (i, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ri = { attribute: !0, type: String, converter: Ct, reflect: !1, hasChanged: Wt }, oi = (i = ri, t, e) => {
...
var ai = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, tt = (i, t, e, s) => {
...
ut = tt([
  _t("meraki-content-filter-card-editor")
], ut);
...
var B = {};
const Ie = "[0-9]+", pi = "[A-Z $%*+\\-./:]+";
let dt = "(?:[u3000-u303F]|[u3040-u309F]|[u30A0-u30FF]|[uFF00-uFFEF]|[u4E00-u9FAF]|[u2605-u2606]|[u2190-u2195]|u203B|[u2010u2015u2018u2019u2025u2026u201Cu201Du2225u2260]|[u0391-u0451]|[u00A7u00A8u00B1u00B4u00D7u00F7])+";
dt = dt.replace(/u/g, "\\u");
const _i = "(?:(?![A-Z0-9 $%*+\\-./:]|" + dt + `)(?:.|[\r
]))+`;
B.KANJI = new RegExp(dt, "g");
B.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
B.BYTE = new RegExp(_i, "g");
B.NUMERIC = new RegExp(Ie, "g");
B.ALPHANUMERIC = new RegExp(pi, "g");
const mi = new RegExp("^" + dt + "$"), yi = new RegExp("^" + Ie + "$"), wi = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
var Be = {};
const Vt = N, Re = 1335, Ei = 21522, pe = Vt.getBCHDigit(Re);
Be.getEncodedBits = function(t, e) {
  const s = t.bit << 3 | e;
  let n = s << 10;
  for (; Vt.getBCHDigit(n) - pe >= 0; )
    n ^= Re << Vt.getBCHDigit(n) - pe;
  return (s << 10 | n) ^ Ei;
};
var De = {};
const vi = O;
...
Y.prototype.write = function(t) {
  ...
  for (e = 0; e + 2 <= this.data.length; e += 2) {
    let s = Ut.indexOf(this.data[e]) * 45;
    s += Ut.indexOf(this.data[e + 1]), t.put(s, 11);
  }
  this.data.length % 2 && t.put(Ut.indexOf(this.data[e]), 6);
};
var Ai = Y;
const $i = O;
function Q(i) {
  this.mode = $i.BYTE, typeof i == "string" ? this.data = new TextEncoder().encode(i) : this.data = new Uint8Array(i);
}
...
var Mi = xe.exports;
(function(i) {
  const t = O, e = Ci, s = Ai, n = Si, r = Ni, o = B, c = N, a = Mi;
  function l(m) {
  ...
  function f(m) {
    ...
    let g, E;
    return c.isKanjiModeEnabled() ? (g = h(o.BYTE, t.BYTE, m), E = h(o.KANJI, t.KANJI, m)) : (g = h(o.BYTE_KANJI, t.BYTE, m), E = []), w.concat(p, g, E).sort(function($, M) {
 ...
 Suggested mode is: ` + t.toString(g));
  ...
  i.fromArray = function(w) {
    ...
    const g = f(w, c.isKanjiModeEnabled()), E = _(g), v = y(E, p), $ = a.find_path(v.map, "start", "end"), M = [];
    for (let D = 1; D < $.length - 1; D++)
      M.push(v.table[$[D]].node);
...
const Mt = N, Lt = Pt, Ti = ui, Ii = di, Bi = Se, Ri = Pe, zt = ke, jt = kt, Di = gi, $t = Te, xi = Be, Ui = O, Ot = De;
function Li(i, t) {
...
function Fi(i, t) {
  const e = i.size, s = $t.getEncodedBits(t);
  let n, r, o;
  for (let c = 0; c < 18; c++)
    n = Math.floor(c / 3), r = c % 3 + e - 8 - 3, o = (s >> c & 1) === 1, i.set(n, r, o, !0), i.set(r, n, o, !0);
}
function Ht(i, t, e) {
  const s = i.size, n = xi.getEncodedBits(t, e);
  let r, o;
  for (r = 0; r < 15; r++)
...
function zi(i, t, e) {
  ...
  const n = Mt.getSymbolTotalCodewords(i), r = jt.getTotalCodewordsCount(i, t), o = (n - r) * 8;
...
function ji(i, t, e) {
  const s = Mt.getSymbolTotalCodewords(t), n = jt.getTotalCodewordsCount(t, e), r = s - n, o = jt.getBlocksCount(t, e), c = s % o, a = o - c, l = Math.floor(s / o), h = Math.floor(r / o), f = h + 1, d = l - h, u = new Di(d);
  let _ = 0;
...
function Ki(i, t, e, s) {
  ...
  if (Array.isArray(i))
    ...
    let l = t;
    if (!l) {
      const h = Ot.rawSplit(i);
      l = $t.getBestVersionForData(h, e);
    }
    n = Ot.fromString(i, l || 40);
  } else
    throw new Error("Invalid data");
  const r = $t.getBestVersionForData(n, e);
  if (!r)
...
`
  ...
  return Li(a, t), Oi(a), Hi(a, t), Ht(a, e, 0), t >= 7 && Fi(a, t), Vi(a, o), isNaN(s) && (s = zt.getBestMask(
    a,
    Ht.bind(null, a, e)
  )), zt.applyMask(s, a), Ht(a, e, s), {
    modules: a,
    version: t,
...
Ae.create = function(t, e) {
  ...
  let s = Lt.M, n, r;
  return typeof e < "u" && (s = Lt.from(e.errorCorrectionLevel, Lt.M), n = $t.from(e.version), r = zt.from(e.maskPattern), e.toSJISFunc && Mt.setToSJISFunction(e.toSJISFunc)), Ki(t, n, s, r);
};
var Ue = {}, te = {};
(function(i) {
  function t(e) {
...
function qi(i, t, e) {
  ...
  for (let c = 0; c < i.length; c++) {
    ...
    !a && !r && (r = !0), i[c] ? (o++, c > 0 && a > 0 && i[c - 1] || (s += r ? Ft("M", a + e, 0.5 + l + e) : Ft("m", n, 0), n = 0, r = !1), a + 1 < t && i[c + 1] || (s += Ft("h", o), o = 0)) : n++;
  }
  return s;
}
...
var Yi = Object.defineProperty, Qi = Object.getOwnPropertyDescriptor, Tt = (i, t, e, s) => {
...
var Gt = /* @__PURE__ */ ((i) => (i.GET_CONFIG = "meraki_ha/get_config", i.SUBSCRIBE_MERAKI_DATA = "meraki_ha/subscribe_meraki_data", i.GET_CAMERA_STREAM_URL = "meraki_ha/get_camera_stream_url", i.GET_CAMERA_SNAPSHOT = "meraki_ha/get_camera_snapshot", i.GET_VERSION = "meraki_ha/get_version", i.GET_NETWORK_EVENTS = "meraki_ha/get_network_events", i.UPDATE_ENABLED_NETWORKS = "meraki_ha/update_enabled_networks", i.CREATE_GUEST_KEY = "meraki_ha/ipsk/create", i.GET_GUEST_KEYS = "meraki_ha/ipsk/get", i.REVOKE_GUEST_KEY = "meraki_ha/ipsk/revoke", i.TIMED_ACCESS_GET_POLICIES = "meraki_ha/timed_access/get_policies", i))(Gt || {});
const me = async (i, t) => {
  if (!i)
...
const ie = class ie extends I {
  constructor() {
    super(...arguments), this._selectedNetwork = "", this._selectedSSID = "", this._selectedPolicy = "", this._selectedDuration = "60", this._customName = "", this._customPassphrase = "", this._creating = !1, this._error = null, this._success = null, this._networks = [], this._ssids = [], this._policies = [], this._isLoading = !0, this._initDone = !1;
  }
  setConfig(t) {
    if (!t)
      throw new Error("Invalid configuration");
  ...
  async _fetchInitialData() {
    ...
    if (this._initDone = !0, !!this.hass) {
      ...
      try {
        ...
        if (!s) {
          this._error = "Meraki integration not found. Please configure it first.", this._isLoading = !1;
          return;
        }
        ...
        }), this._ssids = Array.isArray(n.ssids) ? n.ssids : [], this._networks.length > 0 && !this._selectedNetwork && (this._selectedNetwork = this._networks[0].id, await this._fetchPolicies(this._selectedNetwork, s));
      } catch (e) {
    ...
    if (this.hass)
      try {
        ...
        const r = await me(this.hass, {
          type: Gt.TIMED_ACCESS_GET_POLICIES,
          config_entry_id: n,
          network_id: t
        });
