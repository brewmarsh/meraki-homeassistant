 ...
 */
const $t = globalThis, Wt = $t.ShadowRoot && ($t.ShadyCSS === void 0 || $t.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Yt = Symbol(), re = /* @__PURE__ */ new WeakMap();
let Ee = class {
  constructor(t, e, s) {
...
}, oe = Wt ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: je, defineProperty: Ke, getOwnPropertyDescriptor: Ge, getOwnPropertyNames: qe, getOwnPropertySymbols: Je, getPrototypeOf: We } = Object, O = globalThis, ae = O.trustedTypes, Ye = ae ? ae.emptyScript : "", Rt = O.reactiveElementPolyfillSupport, ot = (i, t) => i, At = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Ye : null;
      break;
  ...
  return e;
} }, Qt = (i, t) => !je(i, t), ce = { attribute: !0, type: String, converter: At, reflect: !1, useDefault: !1, hasChanged: Qt };
...
let W = class extends HTMLElement {
  ...
  _$ET(t, e) {
    ...
    if (n !== void 0 && s.reflect === !0) {
      const o = (((r = s.converter) == null ? void 0 : r.toAttribute) !== void 0 ? s.converter : At).toAttribute(e, s.type);
  ...
  _$AK(t, e) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const c = s.getPropertyOptions(n), a = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((r = c.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? c.converter : At;
      this._$Em = n;
...
W.elementStyles = [], W.shadowRootOptions = { mode: "open" }, W[ot("elementProperties")] = /* @__PURE__ */ new Map(), W[ot("finalized")] = /* @__PURE__ */ new Map(), Rt == null || Rt({ ReactiveElement: W }), (O.reactiveElementVersions ?? (O.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const at = globalThis, le = (i) => i, St = at.trustedTypes, he = St ? St.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Ce = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, be = "?" + U, Qe = `<${be}>`, K = document, lt = () => K.createComment(""), ht = (i) => i === null || typeof i != "object" && typeof i != "function", Zt = Array.isArray, Ze = (i) => Zt(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Dt = `[
\f\r]`, rt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ue = /-->/g, de = />/g, F = RegExp(`>|${Dt}(?:([^\\s"'>=/]+)(${Dt}*=${Dt}*(?:[^
\f\r"'\`<>=]|("|')|))|$)`, "g"), fe = /'/g, ge = /"/g, $e = /^(?:script|style|textarea|title)$/i, Xe = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), E = Xe(1), Y = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), pe = /* @__PURE__ */ new WeakMap(), z = K.createTreeWalker(K, 129);
function Ae(i, t) {
  if (!Zt(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return he !== void 0 ? he.createHTML(t) : t;
}
const ti = (i, t) => {
  const e = i.length - 1, s = [];
  let n, r = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = rt;
  for (let c = 0; c < e; c++) {
    const a = i[c];
    let l, h, f = -1, d = 0;
    for (; d < a.length && (o.lastIndex = d, h = o.exec(a), h !== null); ) d = o.lastIndex, o === rt ? h[1] === "!--" ? o = ue : h[1] !== void 0 ? o = de : h[2] !== void 0 ? ($e.test(h[2]) && (n = RegExp("</" + h[2], "g")), o = F) : h[3] !== void 0 && (o = F) : o === F ? h[0] === ">" ? (o = n ?? rt, f = -1) : h[1] === void 0 ? f = -2 : (f = o.lastIndex - h[2].length, l = h[1], o = h[3] === void 0 ? F : h[3] === '"' ? ge : fe) : o === ge || o === fe ? o = F : o === ue || o === de ? o = rt : (o = F, n = void 0);
    const u = o === F && i[c + 1].startsWith("/>") ? " " : "";
    r += o === rt ? a + Qe : f >= 0 ? (s.push(l), a.slice(0, f) + Ce + a.slice(f) + U + u) : a + U + (f === -2 ? c : u);
  }
...
class ut {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    if (this.el = ut.createElement(l, s), z.currentNode = this.el.content, e === 2 || e === 3) {
    ...
    for (; (n = z.nextNode()) !== null && a.length < c; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const f of n.getAttributeNames()) if (f.endsWith(Ce)) {
          const d = h[o++], u = n.getAttribute(f).split(U), _ = /([.?@])?(.*)/.exec(d);
          a.push({ type: 1, index: r, name: _[2], strings: u, ctor: _[1] === "." ? ii : _[1] === "?" ? ni : _[1] === "@" ? si : Nt }), n.removeAttribute(f);
        } else f.startsWith(U) && (a.push({ type: 6, index: r }), n.removeAttribute(f));
        if ($e.test(n.tagName)) {
          const f = n.textContent.split(U), d = f.length - 1;
          if (d > 0) {
            n.textContent = St ? St.emptyScript : "";
            for (let u = 0; u < d; u++) n.append(f[u], lt()), z.nextNode(), a.push({ type: 2, index: ++r });
            n.append(f[d], lt());
          }
        }
        ...
        let f = -1;
        for (; (f = n.data.indexOf(U, f + 1)) !== -1; ) a.push({ type: 7, index: r }), f += U.length - 1;
      }
      r++;
    }
  }
...
class ei {
  ...
  u(t) {
    ...
    z.currentNode = n;
    let r = z.nextNode(), o = 0, c = 0, a = s[0];
    for (; a !== void 0; ) {
      if (o === a.index) {
        let l;
        a.type === 2 ? l = new wt(r, r.nextSibling, this, t) : a.type === 1 ? l = new a.ctor(r, a.name, a.strings, this, t) : a.type === 6 && (l = new ri(r, this, t)), this._$AV.push(l), a = s[++c];
      }
      o !== (a == null ? void 0 : a.index) && (r = z.nextNode(), o++);
    }
    return z.currentNode = K, n;
  }
  p(t) {
    let e = 0;
...
class wt {
  ...
  _$AI(t, e = this) {
    t = Q(this, t, e), ht(t) ? t === P || t == null || t === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : t !== this._$AH && t !== Y && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ze(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== P && ht(this._$AH) ? this._$AA.nextSibling.data = t : this.T(K.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var r;
    const { values: e, _$litType$: s } = t, n = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = ut.createElement(Ae(s.h, s.h[0]), this.options)), s);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let s, n = 0;
    for (const r of t) n === e.length ? e.push(s = new wt(this.O(lt()), this.O(lt()), this, this.options)) : s = e[n], s._$AI(r), n++;
...
class Nt {
  ...
  _$AI(t, e = this, s, n) {
    ...
    let o = !1;
    if (r === void 0) t = Q(this, t, e, 0), o = !ht(t) || t !== this._$AH && t !== Y, o && (this._$AH = t);
    else {
      const c = t;
      let a, l;
      for (t = r[0], a = 0; a < r.length - 1; a++) l = Q(this, c[s + a], e, a), l === Y && (l = this._$AH[a]), o || (o = !ht(l) || l !== this._$AH[a]), l === P ? t = P : t !== P && (t += (l ?? "") + r[a + 1]), this._$AH[a] = l;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
const Ut = at.litHtmlPolyfillSupport;
Ut == null || Ut(ut, wt), (at.litHtmlVersions ?? (at.litHtmlVersions = [])).push("3.3.2");
const oi = (i, t, e) => {
  const s = (e == null ? void 0 : e.renderBefore) ?? t;
  let n = s._$litPart$;
  if (n === void 0) {
    const r = (e == null ? void 0 : e.renderBefore) ?? null;
    s._$litPart$ = n = new wt(t.insertBefore(lt(), r), r, void 0, e ?? {});
  }
  return n._$AI(i), n;
};
/**
...
var ve;
M._$litElement$ = !0, M.finalized = !0, (ve = j.litElementHydrateSupport) == null || ve.call(j, { LitElement: M });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ai = { attribute: !0, type: String, converter: At, reflect: !1, hasChanged: Qt }, ci = (i = ai, t, e) => {
...
var li = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, it = (i, t, e, s) => {
...
ft = it([
  q("meraki-content-filter-card-editor")
], ft);
...
Et.prototype.set = function(i, t, e, s) {
  const n = i * this.size + t;
  this.data[n] = e, s && (this.reservedBit[n] = !0);
};
Et.prototype.get = function(i, t) {
  return this.data[i * this.size + t];
};
Et.prototype.xor = function(i, t, e) {
  this.data[i * this.size + t] ^= e;
};
Et.prototype.isReserved = function(i, t) {
...
Tt.getBlocksCount = function(t, e) {
  switch (e) {
    case L.L:
      return Ct[(t - 1) * 4 + 0];
    case L.M:
...
Tt.getTotalCodewordsCount = function(t, e) {
  switch (e) {
    case L.L:
      return bt[(t - 1) * 4 + 0];
    case L.M:
...
var Te = {}, It = {};
const ct = new Uint8Array(512), Pt = new Uint8Array(256);
(function() {
  let t = 1;
  for (let e = 0; e < 255; e++)
    ct[e] = t, Pt[t] = e, t <<= 1, t & 256 && (t ^= 285);
...
te.prototype.initialize = function(t) {
  this.degree = t, this.genPoly = Ie.generateECPolynomial(this.degree);
};
te.prototype.encode = function(t) {
  if (!this.genPoly)
...
var _i = te, Be = {}, H = {}, ee = {};
ee.isValid = function(t) {
  return !isNaN(t) && t >= 1 && t <= 40;
};
var B = {};
const xe = "[0-9]+", mi = "[A-Z $%*+\\-./:]+";
let gt = "(?:[u3000-u303F]|[u3040-u309F]|[u30A0-u30FF]|[uFF00-uFFEF]|[u4E00-u9FAF]|[u2605-u2606]|[u2190-u2195]|u203B|[u2010u2015u2018u2019u2025u2026u201Cu201Du2225u2260]|[u0391-u0451]|[u00A7u00A8u00B1u00B4u00D7u00F7])+";
gt = gt.replace(/u/g, "\\u");
const yi = "(?:(?![A-Z0-9 $%*+\\-./:]|" + gt + `)(?:.|[\r
]))+`;
B.KANJI = new RegExp(gt, "g");
B.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
B.BYTE = new RegExp(yi, "g");
B.NUMERIC = new RegExp(xe, "g");
B.ALPHANUMERIC = new RegExp(mi, "g");
const wi = new RegExp("^" + gt + "$"), vi = new RegExp("^" + xe + "$"), Ei = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function(i) {
  const t = N, e = Tt, s = Mt, n = H, r = ee, o = 7973, c = t.getBCHDigit(o);
  function a(d, u, _) {
    for (let y = 1; y <= 40; y++)
  ...
  i.from = function(u, _) {
    ...
    typeof y > "u" && (y = n.BYTE);
    const k = t.getSymbolTotalCodewords(u), m = e.getTotalCodewordsCount(u, _), w = (k - m) * 8;
...
var Re = {};
const jt = N, De = 1335, Ci = 21522, me = jt.getBCHDigit(De);
Re.getEncodedBits = function(t, e) {
  const s = t.bit << 3 | e;
  let n = s << 10;
  for (; jt.getBCHDigit(n) - me >= 0; )
    n ^= De << jt.getBCHDigit(n) - me;
  return (s << 10 | n) ^ Ci;
};
var Ue = {};
const bi = H;
...
X.prototype.write = function(t) {
  ...
  for (e = 0; e + 2 <= this.data.length; e += 2) {
    let s = Ot.indexOf(this.data[e]) * 45;
    s += Ot.indexOf(this.data[e + 1]), t.put(s, 11);
  }
  this.data.length % 2 && t.put(Ot.indexOf(this.data[e]), 6);
};
var Si = X;
const Pi = H;
function tt(i) {
...
var Ii = Le.exports;
(function(i) {
  const t = H, e = $i, s = Si, n = ki, r = Ti, o = B, c = N, a = Ii;
  function l(m) {
  ...
  function f(m) {
    ...
    let g, v;
    return c.isKanjiModeEnabled() ? (g = h(o.BYTE, t.BYTE, m), v = h(o.KANJI, t.KANJI, m)) : (g = h(o.BYTE_KANJI, t.BYTE, m), v = []), w.concat(p, g, v).sort(function(S, T) {
  ...
  function y(m, w) {
    ...
    for (let b = 0; b < m.length; b++) {
      ...
      for (let D = 0; D < S.length; D++) {
        const I = S[D], st = "" + b + D;
        T.push(st), p[st] = { node: I, lastCount: 0 }, g[st] = {};
        for (let xt = 0; xt < v.length; xt++) {
          const x = v[xt];
          p[x] && p[x].node.mode === I.mode ? (g[x][st] = d(p[x].lastCount + I.length, I.mode) - d(p[x].lastCount, I.mode), p[x].lastCount += I.length) : (p[x] && (p[x].lastCount = I.length), g[x][st] = d(I.length, I.mode) + 4 + t.getCharCountIndicator(I.mode, w));
        }
      }
      v = T;
    }
 ...
 Suggested mode is: ` + t.toString(g));
  ...
  i.fromArray = function(w) {
    ...
    const g = f(w, c.isKanjiModeEnabled()), v = _(g), b = y(v, p), S = a.find_path(b.map, "start", "end"), T = [];
    for (let D = 1; D < S.length - 1; D++)
      T.push(b.table[S[D]].node);
    return i.fromArray(u(T));
...
const Bt = N, Vt = Mt, Bi = fi, xi = gi, Ri = ke, Di = Ne, Kt = Me, Gt = Tt, Ui = _i, kt = Be, Li = Re, Oi = H, Ht = Ue;
function Vi(i, t) {
  const e = i.size, s = Di.getPositions(t);
...
function zi(i, t) {
  const e = i.size, s = kt.getEncodedBits(t);
  let n, r, o;
  for (let c = 0; c < 18; c++)
...
function Ki(i, t, e) {
  ...
  const n = Bt.getSymbolTotalCodewords(i), r = Gt.getTotalCodewordsCount(i, t), o = (n - r) * 8;
...
function Gi(i, t, e) {
  const s = Bt.getSymbolTotalCodewords(t), n = Gt.getTotalCodewordsCount(t, e), r = s - n, o = Gt.getBlocksCount(t, e), c = s % o, a = o - c, l = Math.floor(s / o), h = Math.floor(r / o), f = h + 1, d = l - h, u = new Ui(d);
  let _ = 0;
  ...
  for (let S = 0; S < o; S++) {
    const T = S < a ? h : f;
    y[S] = w.slice(_, _ + T), k[S] = u.encode(y[S]), _ += T, m = Math.max(m, T);
  }
  const p = new Uint8Array(s);
  let g = 0, v, b;
  for (v = 0; v < m; v++)
    for (b = 0; b < o; b++)
      v < y[b].length && (p[g++] = y[b][v]);
  for (v = 0; v < d; v++)
    for (b = 0; b < o; b++)
      p[g++] = k[b][v];
  return p;
...
function qi(i, t, e, s) {
  ...
  if (Array.isArray(i))
    ...
    if (!l) {
      ...
      l = kt.getBestVersionForData(h, e);
    }
    n = Ht.fromString(i, l || 40);
  } else
    throw new Error("Invalid data");
  const r = kt.getBestVersionForData(n, e);
  if (!r)
...
`
  ...
  const o = Ki(t, e, n), c = Bt.getSymbolSize(t), a = new xi(c);
  return Vi(a, t), Hi(a), Fi(a, t), Ft(a, e, 0), t >= 7 && zi(a, t), ji(a, o), isNaN(s) && (s = Kt.getBestMask(
    a,
    Ft.bind(null, a, e)
  )), Kt.applyMask(s, a), Ft(a, e, s), {
    modules: a,
    version: t,
...
Se.create = function(t, e) {
  ...
  let s = Vt.M, n, r;
  return typeof e < "u" && (s = Vt.from(e.errorCorrectionLevel, Vt.M), n = kt.from(e.version), r = Kt.from(e.maskPattern), e.toSJISFunc && Bt.setToSJISFunction(e.toSJISFunc)), qi(t, n, s, r);
};
var Oe = {}, ie = {};
(function(i) {
  function t(e) {
...
function Wi(i, t, e) {
  ...
  for (let c = 0; c < i.length; c++) {
    ...
    !a && !r && (r = !0), i[c] ? (o++, c > 0 && a > 0 && i[c - 1] || (s += r ? zt("M", a + e, 0.5 + l + e) : zt("m", n, 0), n = 0, r = !1), a + 1 < t && i[c + 1] || (s += zt("h", o), o = 0)) : n++;
  }
  return s;
}
Ve.render = function(t, e, s) {
...
vt.create = qt.create;
vt.toCanvas = ne.bind(null, He.render);
vt.toDataURL = ne.bind(null, He.renderToDataURL);
vt.toString = ne.bind(null, function(i, t, e) {
  return Qi.render(i, e);
});
var Zi = Object.defineProperty, Xi = Object.getOwnPropertyDescriptor, J = (i, t, e, s) => {
...
let G = class extends M {
  ...
  async _generateQR() {
    ...
    try {
      this._qrSvg = await vt.toString(e, {
        type: "svg",
        margin: 2,
        color: {
          dark: "#000000",
...
J([
  C()
], G.prototype, "_qrSvg", 2);
G = J([
  q("meraki-wifi-qr-card")
], G);
...
pt = J([
  q("meraki-wifi-qr-card-editor")
], pt);
customElements.get("meraki-wifi-qr-card") || customElements.define("meraki-wifi-qr-card", G);
window.customCards = window.customCards || [];
...
var tn = Object.defineProperty, en = Object.getOwnPropertyDescriptor, nt = (i, t, e, s) => {
...
mt = nt([
  q("meraki-network-vitals-card-editor")
], mt);
window.customCards = window.customCards || [];
...
var nn = Object.defineProperty, sn = Object.getOwnPropertyDescriptor, A = (i, t, e, s) => {
...
A([
  C()
], $.prototype, "_selectedNetwork", 2);
A([
  C()
], $.prototype, "_selectedSSID", 2);
A([
  C()
], $.prototype, "_selectedPolicy", 2);
A([
  C()
], $.prototype, "_selectedDuration", 2);
A([
  C()
], $.prototype, "_customName", 2);
A([
  C()
], $.prototype, "_customPassphrase", 2);
A([
  C()
], $.prototype, "_creating", 2);
A([
  C()
], $.prototype, "_error", 2);
A([
  C()
], $.prototype, "_success", 2);
A([
  C()
], $.prototype, "_networks", 2);
A([
  C()
], $.prototype, "_ssids", 2);
A([
  C()
], $.prototype, "_policies", 2);
A([
  C()
], $.prototype, "_loading", 2);
A([
  C()
], $.prototype, "_initDone", 2);
...
yt = A([
  q("meraki-guest-access-card-editor")
], yt);
...
export {
  ...
  yt as MerakiGuestAccessCardEditor
};
