...
from custom_components.meraki_ha.sensor import MerakiSSIDAvailabilitySensor # Assuming this is the correct sensor
from custom_components.meraki_ha.entity import MerakiEntity # Base entity if needed for context
...
# Test function
def test_ssid_sensor_device_info_linking(mock_hass, mock_coordinator, mock_device_registry):
    ...
    with patch('homeassistant.helpers.device_registry.async_get', return_value=mock_device_registry):
        ...
        expected_ssid_device_identifiers = {(DOMAIN, f"{SSID_INFO_RAW['networkId']}_{SSID_INFO_RAW['number']}")}
