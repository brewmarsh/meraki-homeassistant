"""Sensor for Meraki switch energy usage."""
...
class MerakiSwitchEnergySensor(
    CoordinatorEntity,
    SensorEntity,
):
    """
    Representation of a Meraki switch energy sensor.

    This sensor displays the aggregated PoE usage for a Meraki MS switch
    in kWh. The attributes provide a breakdown of PoE usage per port.
    """
    ...
    def __init__(
        ...
        self._attr_name = format_entity_name(self._device["name"], "Energy")
    ...
    def native_value(self) -> float | None:
        ...
        # We divide by 1000 to get the value in kWh.
        if total_poe_usage_wh > 0:
            return round(total_poe_usage_wh / 1000, 2)
        return 0.0
