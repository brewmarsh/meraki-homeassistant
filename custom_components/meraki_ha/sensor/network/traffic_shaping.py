...
class TrafficShapingSensor(CoordinatorEntity[MerakiDataUpdateCoordinator], MerakiNetworkEntity, SensorEntity):
    """Representation of a sensor that shows traffic shaping settings."""

    def __init__(self, coordinator: MerakiDataUpdateCoordinator, config_entry: ConfigEntry, network_id: str) -> None:
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        traffic_shaping = self.coordinator.data.get("traffic_shaping", {}).get(self.network_id, {})
