...
class MerakiSSIDEncryptionModeSensor(
    ...
    def __init__(
        ...
        self._attr_name = format_entity_name(
            f"{ssid_name} Encryption Mode", "sensor", name_format, apply_format=False
        )
        self._attr_unique_id = f"{self._ssid_data['unique_id']}_encryption_mode"
    ...
    def _update_sensor_state(self) -> None:
        ...
        if current_ssid_data:
            ...
            self._attr_native_value = self._ssid_data.get("encryptionMode")
        else:
