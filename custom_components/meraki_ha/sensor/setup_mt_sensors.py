...
if TYPE_CHECKING:
    from .. import MerakiDevice
_LOGGER = logging.getLogger(__name__)
def async_setup_mt_sensors(coordinator: MerakiDataUpdateCoordinator, device_info: MerakiDevice | dict) -> list[Entity]:
    ...
    if sensor_descriptions is None:
        ...
        sensor_descriptions = [desc for desc_list in MT_SENSOR_MODELS.values() for desc in desc_list]
        seen = set()
        unique_descriptions = []
