...
class MerakiSSIDAvailabilitySensor(MerakiEntity, SensorEntity):
    ...
    def _update_sensor_state(self) -> None:
        ...
        # Find the specific SSID data from the coordinator for the current
        # device and SSID number
    ...
    def icon(self) -> str:
        ...
        """
        # Icon changes based on whether the SSID is considered ON (enabled) or
        # OFF.
    ...
    # If MerakiEntity needs adjustment for SSID-specific entities, that was
    # handled there.
