...
DEVICE_CAPABILITIES: Final = {
    ...
    "MT15": ["co2", "tvoc", "pm25", "temperature", "humidity", "noise", "signal_strength"],
    ...
    "MX64": ["uplinks", "performance", "vlans", "cellular", "appliance_ports", "reboot", "status"],
    "MX65": ["uplinks", "performance", "vlans", "cellular", "appliance_ports", "reboot", "status"],
    "MX67": ["uplinks", "performance", "vlans", "cellular", "appliance_ports", "reboot", "status"],
    "MX68": ["uplinks", "performance", "vlans", "cellular", "appliance_ports", "reboot", "status"],
    "MX75": ["uplinks", "performance", "vlans", "cellular", "appliance_ports", "reboot", "status"],
    "MX85": ["uplinks", "performance", "vlans", "cellular", "appliance_ports", "reboot", "status"],
