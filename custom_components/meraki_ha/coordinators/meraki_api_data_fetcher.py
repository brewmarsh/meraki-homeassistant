...
class MerakiApiDataFetcher:
    ...
    async def fetch_all_data(
        ...
        if networks and devices:
            ...
            # Step 5: Process firmware upgrade data
            self._process_firmware_upgrades(devices, firmware_upgrade_data_raw)
...
from .meraki_api_helpers import (
    ...
    def _process_firmware_upgrades(
        self, devices: List[Dict[str, Any]], firmware_upgrade_data_raw: Optional[List[Dict[str, Any]]]
    ) -> None:
