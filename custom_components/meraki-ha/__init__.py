...
from .const import DOMAIN, DATA_COORDINATOR, DEFAULT_SCAN_INTERVAL  # Updated import
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    scan_interval = timedelta(seconds=DEFAULT_SCAN_INTERVAL)  # Updated usage

    coordinator = MerakiCoordinator(
        hass, scan_interval, entry  # Removed api_key and org_id
    )
