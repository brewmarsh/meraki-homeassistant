...
def fix_file(file_path):
    ...
    content = re.sub(
        r"from custom_components\.meraki_ha\.const\.integration import\s*\(\s*\(\s*,",
    ...
    content = re.sub(
        r"from custom_components\.meraki_ha\.const\.integration import from custom_components\.meraki_ha\.const\.integration import DOMAIN",
    ...
    content = re.sub(
        r"from custom_components\.meraki_ha\.const\.integration import from custom_components\.meraki_ha\.const\.websocket import",
