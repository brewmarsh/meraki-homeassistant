...
def mock_coordinator():
    ...
    vlan1 = {
        ...
        "dhcpHandling": "Run a DHCP server",  # Changed from dhcp_handling to dhcpHandling
    }
...
async def test_vlan_sensor_creation(mock_coordinator):
    ...
    # assert ipv4_enabled_sensor.name == "IPv4 Enabled" # Cannot access name without platform
    ...
    # assert ipv4_ip_sensor.name == "IPv4 Interface IP" # Cannot access name without platform
    ...
    # assert ipv4_uplink_sensor.name == "IPv4 Uplink" # Cannot access name without platform
    ...
    # assert ipv6_enabled_sensor.name == "IPv6 Enabled" # Cannot access name without platform
    ...
    # assert ipv6_ip_sensor.name == "IPv6 Interface IP" # Cannot access name without platform
    ...
    # assert ipv6_uplink_sensor.name == "IPv6 Uplink" # Cannot access name without platform
