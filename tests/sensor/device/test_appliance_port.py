        ...
        'devices': [
            {
                ...
                'ports': [
                    {'number': 1, 'enabled': True, 'status': 'connected', 'speed': '1000 Mbps', 'vlan': 1, 'type': 'access', 'accessPolicy': None},
                    {'number': 2, 'enabled': True, 'status': 'disconnected', 'speed': None, 'vlan': 1, 'type': 'access', 'accessPolicy': None},
                    {'number': 3, 'enabled': False, 'status': 'disconnected', 'speed': None, 'vlan': 1, 'type': 'access', 'accessPolicy': None},
                ],
            }
        ]
    }
