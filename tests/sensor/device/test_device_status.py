...
def test_device_status_sensor(mock_device_coordinator: MagicMock) -> None:
    ...
    sensor1: MerakiDeviceStatusSensor = MerakiDeviceStatusSensor(
    ...
    assert isinstance(sensor1.extra_state_attributes, dict)
    ...
    assert isinstance(sensor2.extra_state_attributes, dict)
