"""Tests for the Meraki switch power sensor."""

from unittest.mock import MagicMock

import pytest

from custom_components.meraki_ha.sensor.device.switch_power import MerakiSwitchPowerSensor
...
def test_switch_power_sensor(mock_device_coordinator):
    """Test the switch power sensor."""
    device = mock_device_coordinator.data["devices"][0]
    sensor = MerakiSwitchPowerSensor(mock_device_coordinator, device)
    assert sensor.unique_id == "dev1_power"
    assert sensor.name == "Switch Power"
