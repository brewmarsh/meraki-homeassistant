...
async def test_discover_entities_creates_client_status_sensors_when_enabled(
    ...
    mock_coordinator.data["clients"] = [
        {"mac": "00:11:22:33:44:55", "networkId": "N_1234", "status": "Online"},
        {"mac": "AA:BB:CC:DD:EE:FF", "networkId": "N_5678", "status": "Offline"},
        {"mac": "11:22:33:44:55:66", "networkId": "N_OTHER", "status": "Online"},
    ]

    # Create a mock config entry with the option enabled
    ...
    # The client in N_OTHER should be ignored because N_OTHER is not in
